(function () {
    ...
    var a = this, b = {android: navigator.userAgent.toLowerCase().indexOf("android") > -1}, c = function (a, b, c) {
            ...
            var h = a.split(","), i = function (g) {
                ...
                if (l.end != -1)for (var m = 0; m < l.end; m++) {
                    k = l.path[m];
    ...
    var a = this, b = function (a, b, c) {
            ...
            return a
        }(), i = 50, j = 50, k = h > -1 && h < 9, l = 9 == h, m = function (a) {
        ...
        }, q = "katavorio-drag-scope", r = ["stop", "start", "drag", "drop", "over", "out", "beforeStart"],
        s = function () {
        }, t = function () {
            return !0
        }, u = function (a, b, c) {
            ...
            var V = function (a, b) {
                if (U[a])for (var c = 0; c < U[a].length; c++)try {
                    U[a][c](b)
                } catch (a) {
                }
            };
            this.notifyStart = function (a) {
                ...
                R = {w: b[0], h: b[1]}, a && h.notifySelectionDragStart(this)
            };
            var W;
            this.unmark = function (a, d) {
                ...
                T.length = 0;
                var e = this.toGrid([l[0] + a, l[1] + c]), f = J(e, s);
                ...
                var h = {x: f[0], y: f[1], w: this.size[0], h: this.size[1]},
                    i = {x: h.x + o[0], y: h.y + o[1], w: h.w, h: h.h}, j = null;
    ...
    a.Katavorio = function (a) {
        ...
        var B = {}, C = function (a, c, d) {
            var f = e(c) ? c : c.id, g = !!e(c) || c.active !== !1, h = B[f] || function () {
    ...
    j.jsPlumbUtil = {
        ...
        extend: function (b, c, d) {
            var e;
            for (c = a(c) ? c : [c], e = 0; e < c.length; e++)for (var f in c[e].prototype)c[e].prototype.hasOwnProperty(f) && (b.prototype[f] = c[e].prototype[f]);
            var g = function (a, b) {
                return function () {
            ...
            if (arguments.length > 2)for (e = 2; e < arguments.length; e++)h(arguments[e]);
            return b
        },
        uuid: function () {
            return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (a) {
        ...
        this.bind = function (b, c, d) {
            ...
            if (c) e.unshift(arguments); else {
                if (c = !0, !b && a[g]) {
                    var k = a[g].length, l = 0, m = !1, n = null;
                    if (!this.shouldFireEvent || this.shouldFireEvent(g, h, i))for (; !m && l < k && n !== !1;) {
                        if (d[g]) a[g][l].apply(this, [h, i]); else try {
                            n = a[g][l].apply(this, [h, i])
                        } catch (a) {
                            j.jsPlumbUtil.log("jsPlumb: fire failed for event " + g + " : " + a)
                        }
    ...
    var a, b = this, c = [], d = b.jsPlumbUtil, e = function () {
        ...
        h = function (a, b, c, d) {
            ...
            if (this.getDefaultType = function () {
                ...
                }, a.events)for (var l in a.events)b.bind(l, a.events[l]);
            this.clone = function () {
    ...
    var o = 0, p = function () {
        ...
        this.version = "2.5.1", f && r.extend(this.Defaults, f), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, d.EventGenerator.apply(this);
        var h = this, i = p(), j = h.bind, l = {}, n = 1, o = function (a) {
            if (null == a)return null;
            if (3 === a.nodeType || 8 === a.nodeType)return {el: a, text: !0};
            var b = h.getElement(a);
            return {el: b, id: d.isString(a) && null == b ? a : $(b)}
        };
        ...
        var u = null, v = !1, w = [], x = {}, y = {}, z = {}, A = {}, B = {}, C = {}, D = !1, E = [], F = !1, G = null,
            H = this.Defaults.Scope, I = 1, J = function () {
                return "" + I++
            }, K = function (a, b) {
                s ? s.appendChild(a) : b ? this.getElement(b).appendChild(a) : this.appendToRoot(a)
            }.bind(this), L = function (a, b, c, d) {
                if (!F) {
                    var f, g = $(a), i = h.getDragManager();
                    i && (f = i.getElementsForDraggable(g)), null == c && (c = e());
                    var j = va({elId: g, offset: b, recalc: !1, timestamp: c});
                    if (f && j && j.o)for (var k in f)va({
                        elId: f[k].id,
                        offset: {left: j.o.left + f[k].offset.left, top: j.o.top + f[k].offset.top},
                        recalc: !1,
                        timestamp: c
                    });
                ...
                if (!r.headless) {
                    ...
                    if (g && r.isDragSupported(a, h)) {
                        ...
                        if (i = r.extend({}, i), r.isAlreadyDraggable(a, h)) c.force && h.initDraggable(a, i); else {
                            var j = r.dragEvents.drag, k = r.dragEvents.stop, l = r.dragEvents.start, m = !1;
                            ua(e, a), i[l] = d.wrap(i[l], function () {
                                if (h.setHoverSuspended(!0), h.select({source: a}).addClass(h.elementDraggingClass + " " + h.sourceElementDraggingClass, !0), h.select({target: a}).addClass(h.elementDraggingClass + " " + h.targetElementDraggingClass, !0), h.setConnectionBeingDragged(!0), i.canDrag)return c.canDrag()
                                ...
                                for (var a, b = arguments[0].selection, c = function (b) {
                                    ...
                                    }]), L(b[2].el, a)), h.removeClass(b[0], "jtk-dragged"), h.select({source: b[2].el}).removeClass(h.elementDraggingClass + " " + h.sourceElementDraggingClass, !0), h.select({target: b[2].el}).removeClass(h.elementDraggingClass + " " + h.targetElementDraggingClass, !0), h.getDragManager().dragEnded(b[2].el)
                ...
                var g = function (a, b, d) {
                    ...
                    if (c[a] && !c[a].endpoint && !c[a + "Endpoint"] && !c.newConnection) {
                        ...
                        if (h = h ? h[e] : null) {
                            ...
                            var i = null != h.endpoint && h.endpoint._jsPlumb ? h.endpoint : g(c[a], h.def, b);
                            if (i.isFull())return !1;
                            c[a + "Endpoint"] = i, !c.scope && h.def.scope && (c.scope = h.def.scope), h.uniqueEndpoint ? h.endpoint ? i.finalEndpoint = h.endpoint : (h.endpoint = i, i.setDeleteOnEmpty(!1)) : i.setDeleteOnEmpty(!0)
                        }
                    }
                };
                ...
                a._jsPlumb = h, a.newConnection = R, a.newEndpoint = T, a.endpointsByUUID = y, a.endpointsByElement = x, a.finaliseConnection = S, a.id = "con_" + J();
                var c = new b(a);
                ...
                var c = h.Defaults.EndpointType || r.Endpoint, d = r.extend({}, a);
                d._jsPlumb = h, d.newConnection = R, d.newEndpoint = T, d.endpointsByUUID = y, d.endpointsByElement = x, d.fireDetachEvent = ba, d.elementId = b || $(d.source);
                var e = new c(d);
                return e.id = "ep_" + J(), ua(d.elementId, d.source), r.headless || h.getDragManager().endpointAdded(d.source, b), e
            }, U = function (a, b, c) {
                var d = x[a];
        ...
        this.setConnectionBeingDragged = function (a) {
            ...
            for (var f = [], g = d.isArray(a) || null != a.length && !d.isString(a) ? a : [a], i = 0, j = g.length; i < j; i++) {
                e.source = h.getElement(g[i]), sa(e.source);
                var k = $(e.source), l = T(e, k), m = ua(k, e.source).info.o;
            ...
            c = c || {};
            var e = h.getElement(a), f = $(e), g = r.animEvents.step, i = r.animEvents.complete;
            ...
            if (e) {
                ...
                sa(e.source), c = R(e), S(c, e)
            }
            return c
        };
        var _ = [{el: "source", elId: "sourceId", epDefs: "sourceEndpointDefinitions"}, {
            el: "target",
            elId: "targetId",
            epDefs: "targetEndpointDefinitions"
        }], aa = function (a, b, c, d) {
            var e, f, g, h = _[c], i = a[h.elId], j = (a[h.el], a.endpoints[c]), k = {
                index: c,
            ...
            if (b.constructor === r.Endpoint) e = b, e.addConnection(a), b = e.element; else if (f = $(b), g = this[h.epDefs][f], f === a[h.elId]) e = null; else if (g)for (var l in g) {
            ...
            return null != e && (j.detachFromConnection(a), a.endpoints[c] = e, a[h.el] = e.element, a[h.elId] = e.elementId, k[0 === c ? "newSourceId" : "newTargetId"] = e.elementId, ca(k), d || a.repaint()), k.element = b, k
        }.bind(this);
        this.setSource = function (a, b, c) {
            ...
            return d && h.deleteObject({endpoint: d, dontUpdateHover: b, deleteAttachedObjects: c}), h
        }, this.deleteEveryEndpoint = function () {
            var a = h.setSuspendDrawing(!0);
            for (var b in x) {
                var c = x[b];
                if (c && c.length)for (var d = 0, e = c.length; d < e; d++)h.deleteEndpoint(c[d], !0)
            }
            x = {}, z = {}, y = {}, A = {}, B = {}, h.anchorManager.reset();
            var f = h.getDragManager();
            return f && f.reset(), a || h.setSuspendDrawing(!1), h
        };
        var ba = function (a, b, c) {
            var d = h.Defaults.ConnectionType || h.getDefaultConnectionType(), e = a.constructor === d, f = e ? {
                connection: a,
                source: a.source,
                target: a.target,
                sourceId: a.sourceId,
        ...
        }, ca = h.fireMoveEvent = function (a, b) {
        ...
        var da = "isDetachAllowed", ea = "beforeDetach", fa = "checkCondition";
        this.deleteConnection = function (a, b) {
            return !(null == a || (b = b || {}, !b.force && !d.functionChain(!0, !1, [[a.endpoints[0], da, [a]], [a.endpoints[1], da, [a]], [a, da, [a]], [h, fa, [ea, a]]]))) && (a.setHover(!1), ba(a, !a.pending && b.fireEvent !== !1, b.originalEvent), a.endpoints[0].detachFromConnection(a), a.endpoints[1].detachFromConnection(a), d.removeWithFunction(w, function (b) {
                    return a.id === b.id
            ...
            return h.batch(function () {
                for (var d = 0; d < b; d++)c += h.deleteConnection(w[0], a) ? 1 : 0
            }), c
        }, this.deleteConnectionsForElement = function (a, b) {
            b = b || {}, a = h.getElement(a);
            var c = $(a), d = x[c];
            if (d && d.length)for (var e = 0, f = d.length; e < f; e++)d[e].deleteEveryConnection(b);
            return h
        }, this.deleteObject = function (a) {
            var b = {endpoints: {}, connections: {}, endpointCount: 0, connectionCount: 0},
                c = a.deleteAttachedObjects !== !1, e = function (c) {
                    null != c && null == b.connections[c.id] && (a.dontUpdateHover || null == c._jsPlumb || c.setHover(!1), b.connections[c.id] = c, b.connectionCount++)
                }, f = function (d) {
            ...
            for (var g in b.connections) {
                ...
                if (i._jsPlumb) {
                    d.removeWithFunction(w, function (a) {
                        return i.id === a.id
                    }), ba(i, a.fireEvent !== !1 && !i.pending, a.originalEvent);
        ...
        var ga = function (a, b, c, d) {
            ...
            return function () {
                return ga(a, b, arguments, c)
            }
        }, ja = function (a, b) {
            return function () {
                return ha(a, b, arguments)
            }
        }, ka = function (a, b) {
            var c = [];
            if (a)if ("string" == typeof a) {
                if ("*" === a)return a;
                c.push(a)
            } else if (b) c = a; else if (a.length)for (var d = 0, e = a.length; d < e; d++)c.push(o(a[d]).id); else c.push(o(a).id);
            return c
        }, la = function (a, b, c) {
        ...
        this.getConnections = function (a, b) {
            ...
            for (var c = a.scope || h.getDefaultScope(), d = ka(c, !0), e = ka(a.source), f = ka(a.target), g = !b && d.length > 1 ? {} : [], i = function (a, c) {
                if (!b && d.length > 1) {
                    var e = g[a];
                    null == e && (e = g[a] = []), e.push(c)
                } else g.push(c)
            }, j = 0, k = w.length; j < k; j++) {
                var l = w[j], m = l.proxies && l.proxies[0] ? l.proxies[0].originalEp.elementId : l.sourceId,
                    n = l.proxies && l.proxies[1] ? l.proxies[1].originalEp.elementId : l.targetId;
                la(d, l.scope) && la(e, m) && la(f, n) && i(l.scope, l)
            }
            return g
        };
        var ma = function (a, b) {
            ...
            var c, d, e = {length: a.length, each: ma(a, b), get: na(a)},
            ...
            for (c = 0, d = f.length; c < d; c++)e[f[c]] = ia(a, f[c], b);
            for (c = 0, d = g.length; c < d; c++)e[g[c]] = ja(a, g[c]);
            return e
        }, pa = function (a) {
            var b = oa(a, pa);
            return r.extend(b, {
                setDetachable: ia(a, "setDetachable", pa),
                setReattach: ia(a, "setReattach", pa),
                setConnector: ia(a, "setConnector", pa),
                delete: function () {
                    for (var b = 0, c = a.length; b < c; b++)h.deleteConnection(a[b])
                },
                isDetachable: ja(a, "isDetachable"),
                isReattach: ja(a, "isReattach")
            })
        }, qa = function (a) {
            var b = oa(a, qa);
            return r.extend(b, {
                setEnabled: ia(a, "setEnabled", qa),
                setAnchor: ia(a, "setAnchor", qa),
                isEnabled: ja(a, "isEnabled"),
                deleteEveryConnection: function () {
                    for (var b = 0, c = a.length; b < c; b++)a[b].deleteEveryConnection()
                },
                delete: function () {
                    for (var b = 0, c = a.length; b < c; b++)h.deleteEndpoint(a[b])
                }
            })
        };
        this.select = function (a) {
            return a = a || {}, a.scope = a.scope || "*", pa(a.connections || h.getConnections(a, !0))
        }, this.selectEndpoints = function (a) {
            a = a || {}, a.scope = a.scope || "*";
            var b = !a.element && !a.source && !a.target, c = b ? "*" : ka(a.element), d = b ? "*" : ka(a.source),
                e = b ? "*" : ka(a.target), f = ka(a.scope, !0), g = [];
            for (var h in x) {
                var i = la(c, h, !0), j = la(d, h, !0), k = "*" !== d, l = la(e, h, !0), m = "*" !== e;
            ...
            return r.Connection
        }, this.getId = $, this.appendElement = K;
        var ra = !1;
        ...
        }, ua = h.manage = function (a, b, c) {
            return z[a] || (z[a] = {el: b, endpoints: [], connections: []}, z[a].info = va({
                elId: a,
                timestamp: G
            }), c || h.fire("manageElement", {id: a, info: z[a].info, el: b})), z[a]
        }, va = this.updateOffset = function (a) {
        ...
        this.init = function () {
            ...
            v || (ta(), h.anchorManager = new b.jsPlumb.AnchorManager({jsPlumbInstance: h}), v = !0, h.fire("ready", h))
        }.bind(this), this.log = u,
            this.jsPlumbUIComponent = m, this.makeAnchor = function () {
            var a, c = function (a, c) {
                if (b.jsPlumb.Anchors[a])return new b.jsPlumb.Anchors[a](c);
                if (!h.Defaults.DoNotThrowErrors)throw{msg: "jsPlumb: unknown anchor type '" + a + "'"}
            };
            if (0 === arguments.length)return null;
            var e = arguments[0], f = arguments[1], g = (arguments[2], null);
        ...
        var wa = function (a, b, c, d, e) {
            ...
            return e ? !g : g
        }, xa = function (a, c, e, f, g) {
            var i = new m(c), j = c._jsPlumb.EndpointDropHandler({
                jsPlumb: h, enabled: function () {
                    return a.def.enabled
                }, isFull: function () {
                    var b = h.select({target: a.id}).length;
                    return a.def.maxConnections > 0 && b >= a.def.maxConnections
                }, element: a.el, elementId: a.id, isSource: f, isTarget: g, addClass: function (b) {
                    h.addClass(a.el, b)
                    ...
                    if (null == e || null == e._jsPlumb) {
                        var f = h.deriveEndpointAndAnchorSpec(d.getType().join(" "), !0),
                            g = f.endpoints ? b.jsPlumb.extend(c, {endpoint: a.def.def.endpoint || f.endpoints[1]}) : c;
                        f.anchors && (g = b.jsPlumb.extend(g, {anchor: a.def.def.anchor || f.anchors[1]})), e = h.addEndpoint(a.el, g), e._mtNew = !0
                    }
                    if (c.uniqueEndpoint && (a.def.endpoint = e), e.setDeleteOnEmpty(!0), d.isDetachable() && e.initDraggable(), null != e.anchor.positionFinder) {
                        var i = h.getUIPosition(arguments, h.getZoom()), j = h.getOffset(a.el), k = h.getSize(a.el),
        ...
        this.makeTarget = function (a, c, d) {
            var e = b.jsPlumb.extend({_jsPlumb: this}, d);
            b.jsPlumb.extend(e, c);
            for (var f = e.maxConnections || -1, g = function (a) {
                var c = o(a), d = c.id, g = b.jsPlumb.extend({}, e.dropOptions || {}),
                    i = e.connectionType || "default";
                this.targetEndpointDefinitions[d] = this.targetEndpointDefinitions[d] || {}, sa(d), c.el._isJsPlumbGroup && null == g.rank && (g.rank = -1);
                var j = {
                ...
                e.createEndpoint && (j.uniqueEndpoint = !0, j.endpoint = h.addEndpoint(a, j.def), j.endpoint.setDeleteOnEmpty(!1)), c.def = j, this.targetEndpointDefinitions[d][i] = j, xa(c, e, g, e.isSource === !0, !0), c.el._katavorioDrop[c.el._katavorioDrop.length - 1].targetDef = j
            }.bind(this), i = a.length && a.constructor !== String ? a : [a], j = 0, k = i.length; j < k; j++)g(i[j]);
            return this
            ...
            var f = b.jsPlumb.extend({_jsPlumb: this}, e);
            b.jsPlumb.extend(f, c);
            var g = f.connectionType || "default", i = h.deriveEndpointAndAnchorSpec(g);
            f.endpoint = f.endpoint || i.endpoints[0], f.anchor = f.anchor || i.anchors[0];
            for (var j = f.maxConnections || -1, k = f.onMaxConnections, l = function (c) {
                var e = c.id, i = this.getElement(c.el);
                this.sourceEndpointDefinitions[e] = this.sourceEndpointDefinitions[e] || {}, sa(e);
                var l = {
                ...
                f.createEndpoint && (l.uniqueEndpoint = !0, l.endpoint = h.addEndpoint(a, l.def), l.endpoint.setDeleteOnEmpty(!1)), this.sourceEndpointDefinitions[e][g] = l, c.def = l;
                var m = b.jsPlumb.dragEvents.stop, o = b.jsPlumb.dragEvents.drag,
                    p = b.jsPlumb.extend({}, f.dragOptions || {}), q = p.drag, r = p.stop, s = null, t = !1;
                p.scope = p.scope || f.scope, p[o] = d.wrap(p[o], function () {
                    q && q.apply(this, arguments), t = !1
                }), p[m] = d.wrap(p[m], function () {
                    if (r && r.apply(this, arguments), this.currentlyDragging = !1, null != s._jsPlumb) {
                        var a = f.anchor || this.Defaults.Anchor, b = s.anchor, c = s.connections[0],
                            d = this.makeAnchor(a, e, this), g = s.element;
                        if (null != d.positionFinder) {
                            var i = h.getOffset(g), j = this.getSize(g),
                ...
                var u = function (a) {
                    if (3 !== a.which && 2 !== a.button) {
                        var l = this.sourceEndpointDefinitions[e][g];
                        if (l.enabled) {
                            if (e = this.getId(this.getElement(c.el)), f.filter) {
                                var m = d.isString(f.filter) ? wa(a, c.el, f.filter, this, f.filterExclude) : f.filter(a, c.el);
                                if (m === !1)return
                            }
                            var o = this.select({source: e}).length;
                            if (l.maxConnections >= 0 && o >= l.maxConnections)return k && k({
                                element: c.el,
                                maxConnections: j
                            }, a), !1;
                            var q = b.jsPlumb.getPositionOnElement(a, i, n), r = {};
                            b.jsPlumb.extend(r, f), r.isTemporarySource = !0, r.anchor = [q[0], q[1], 0, 0], r.dragOptions = p, l.def.scope && (r.scope = l.def.scope), s = this.addEndpoint(e, r), t = !0, s.setDeleteOnEmpty(!0), l.uniqueEndpoint && (l.endpoint ? s.finalEndpoint = l.endpoint : (l.endpoint = s, s.setDeleteOnEmpty(!1)));
                            var u = function () {
                                h.off(s.canvas, "mouseup", u), h.off(c.el, "mouseup", u), t && (t = !1, h.deleteEndpoint(s))
                            };
                            h.on(s.canvas, "mouseup", u), h.on(c.el, "mouseup", u);
                            var v = {};
                            if (l.def.extract)for (var w in l.def.extract) {
                                var x = (a.srcElement || a.target).getAttribute(w);
                                x && (v[l.def.extract[w]] = x)
                            }
                            h.trigger(s.canvas, "mousedown", a, v), d.consume(a)
                        }
                    }
                }.bind(this);
                this.on(c.el, "mousedown", u), l.trigger = u, f.filter && (d.isString(f.filter) || d.isFunction(f.filter)) && h.setDragFilter(c.el, f.filter);
                var v = b.jsPlumb.extend({}, f.dropOptions || {});
                xa(c, f, v, !0, f.isTarget === !0)
        ...
        this.toggleSourceEnabled = function (a, b) {
            ...
            return Aa("target", a, null, !0, b), this.isTargetEnabled(a, b)
        ...
        this.repaint = function (a, b, c) {
            ...
            return Ca(a, function (a) {
                var d = c ? a : h.getId(a);
                h.updateOffset({elId: d, recalc: !0, timestamp: b});
                var e = h.getDragManager();
                e && e.updateOffsets(d), h.repaint(a)
            })
        }, this.repaintEverything = function () {
            var a, b = e();
            for (a in x)h.updateOffset({elId: a, recalc: !0, timestamp: b});
            ...
            var d = function (a) {
                ...
                if (i)for (c.push(g), e = 0, f = i.length; e < f; e++)h.deleteEndpoint(i[e], !1);
                if (delete x[g.id], b && g.el && 3 !== g.el.nodeType && 8 !== g.el.nodeType)for (e = 0, f = g.el.childNodes.length; e < f; e++)d(g.el.childNodes[e])
            };
            return d(a), this
        };
        var Da = function (a, b) {
        ...
        this.remove = function (a, b) {
            ...
            h.silently(function () {
                ra = !1, h.removeAllGroups(), h.removeGroupManager(), h.deleteEveryEndpoint(), h.unbind(), this.targetEndpointDefinitions = {}, this.sourceEndpointDefinitions = {}, w.length = 0, this.doReset && this.doReset()
            }.bind(this))
        };
        var Ea = function (a) {
        ...
        this.clear = function () {
            h.select().each(Ea), h.selectEndpoints().each(Ea), x = {}, y = {}
        }, this.setDefaultScope = function (a) {
            return H = a, h
        }, this.setDraggable = V, this.deriveEndpointAndAnchorSpec = function (a, b) {
            ...
            delete x[e], this.sourceEndpointDefinitions[b] = this.sourceEndpointDefinitions[e], delete this.sourceEndpointDefinitions[e], this.targetEndpointDefinitions[b] = this.targetEndpointDefinitions[e], delete this.targetEndpointDefinitions[e], this.anchorManager.changeId(e, b);
            var j = this.getDragManager();
            j && j.changeId(e, b), z[b] = z[e], delete z[e];
            ...
            k(f, 0, "source"), k(g, 1, "target"), this.repaint(b)
        ...
        }, this.doWhileSuspended = this.batch, this.getCachedData = Z, this.timestamp = e, this.show = function (a, b) {
            return W(a, "block", b), h
        }, this.toggleVisible = Y, this.toggleDraggable = X, this.addListener = this.bind
    };
    ...
    var a = this, b = a.jsPlumbUtil, c = function (a, b) {
        ...
        this.register = function (g) {
            ...
            if (null != b) {
                c = c || {};
                var e = jsPlumb.getElement(b), g = a.getId(e), h = d[g], i = a.getOffset(e);
                if (h)for (var j in h)if (h.hasOwnProperty(j)) {
                    ...
                    d[g][j] = {id: j, offset: {left: l.left - i.left, top: l.top - i.top}}, f[j] = g
                }
            }
        ...
        var e = l(a), f = e.split(/\s+/), g = function (a, b) {
            for (var c = 0; c < b.length; c++)if (a) f.indexOf(b[c]) === -1 && f.push(b[c]); else {
                var d = f.indexOf(b[c]);
                d !== -1 && f.splice(d, 1)
            }
        };
    ...
    b.Endpoint = function (a) {
            ...
            if (!p && b.isDragSupported(this.element)) {
                var g, h = {id: null, element: null}, m = null, n = !1, o = null, q = d(this, h, i),
                    ...
                    v = b.dragEvents.drag, w = b.dragEvents.beforeStart, x = function (a) {
                        ...
                        if (p === !1 ? l = !1 : "object" == typeof p ? b.extend(p, g || {}) : p = g || {}, l === !1)return i.stopDrag && i.stopDrag(this.canvas), q.stopDrag(), !1;
                        ...
                        var s = this._jsPlumb.instance.getOffset(this.canvas), t = this.canvas,
                            u = this._jsPlumb.instance.getSize(this.canvas);
                        e(h, i, s, u), i.setAttributes(this.canvas, {dragId: h.id, elId: this.elementId});
        ...
        return function (b) {
            ...
            var e = d.getDropEvent(arguments), f = d.getDragObject(arguments), g = d.getAttribute(f, "dragId"),
                h = (d.getAttribute(f, "elId"), d.getAttribute(f, "originalScope")), i = d.floatingConnections[g];
            if (null != i) {
    ...
    var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a, c, d, e, f) {
        if (!a.Defaults.DoNotThrowErrors && null == b.Connectors[c][d])throw{msg: "jsPlumb: unknown connector type '" + d + "'"};
    ...
    c.AnchorManager = function (a) {
        ...
        var w = function (c, d, e, f, g, h, i, j, k, l, m, n) {
            ...
            if (x) {
                ...
                if (y !== -1)for (x.splice(y, 1), o = 0; o < x.length; o++)p = x[o][1], b.addWithFunction(m, p, function (a) {
                    return a.id === p.id
        ...
        this.updateOtherEndpoint = function (a, d, e, f) {
            ...
            if (!m.isSuspendDrawing()) {
                ...
                f = f || m.timestamp(), g = g || {left: 0, top: 0}, e && (e = {
                    left: e.left + g.left,
                    top: e.top + g.top
                });
                for (var t = m.updateOffset({
                    ...
                    if (B || C) {
                        ...
                        B && !l[z] && (l[z] = {
                            ...
                            bottom: [],
                            left: []
                        }), a !== A && m.updateOffset({elId: A, timestamp: f}), a !== z && m.updateOffset({
                            elId: z,
                            timestamp: f
                        });
        ...
        AbstractSegment: function (a) {
            ...
            this.pointOnPath = function (b, c) {
                ...
                var e = this.pointOnPath(b, d), f = c / h * 2 * Math.PI, g = this.anticlockwise ? -1 : 1,
                    i = e.theta + g * f, j = a.cx + this.radius * Math.cos(i), k = a.cy + this.radius * Math.sin(i);
                return {x: j, y: k}
            }
        }, Bezier: function (c) {
    ...
    b.Connectors.AbstractConnector = function (a) {
        ...
        var f = [], g = 0, h = [], i = [], j = a.stub || 0, k = c.isArray(j) ? j[0] : j, l = c.isArray(j) ? j[1] : j,
            ...
            s = null, t = a.editable !== !1 && null != b.ConnectorEditors && null != b.ConnectorEditors[this.type],
        ...
        this.computeMaxSize = function () {
            ...
            if (a.pointAlongPathFrom) {
                if (c.isString(this.loc) || this.loc > 1 || this.loc < 0) {
                    ...
                    if (e = a.pointOnPath(this.loc), g = a.pointAlongPathFrom(this.loc, -this.length), j = d.pointOnLine(e, g, this.length), f === -1) {
                        var o = j;
                        j = e, e = o
                    }
                } else if (0 === this.loc) {
                    if (j = a.pointOnPath(this.loc), g = a.pointAlongPathFrom(this.loc, this.length), e = d.pointOnLine(j, g, this.length), f === -1) {
                        var p = j;
                        j = e, e = p
                    }
    ...
    var a = this, b = a.jsPlumbUtil, c = a.jsPlumbInstance, d = "jtk-group-collapsed", e = "jtk-group-expanded",
        ...
        u = "internal.connectionDetached", v = "removeAll", w = "orphanAll", x = "show", y = "hide", z = function (a) {
            ...
            function g(b) {
                var c = b.getMembers(), d = a.getConnections({source: c}, !0), e = a.getConnections({target: c}, !0),
                    f = {};
            ...
            function p(a) {
                if (!j(a.el, a.pos)) {
                    ...
                    B ? c.remove(a.el) : o(a.el), b.remove(a.el)
                }
            }
            ...
            this.getEl = function () {
                return v
            }, this.id = d.id || b.uuid(), v._isJsPlumbGroup = !0;
            var w = this.getDragArea = function () {
                    var a = c.getSelector(v, f);
                    return a && a.length > 0 ? a[0] : v
                }, x = d.ghost === !0, y = x || d.constrain === !0, z = d.revert !== !1, A = d.orphan === !0,
                B = d.prune === !0, C = d.dropOverride === !0, D = d.proxied !== !1, E = [];
            if (this.connections = {source: [], target: [], internal: []}, this.getAnchor = function (a, b) {
                ...
                d.dragOptions && a.jsPlumb.extend(F, d.dragOptions), c.draggable(d.el, F)
            }
            d.droppable !== !1 && c.droppable(d.el, {
                drop: function (a) {
                    ...
                    if (!b._isJsPlumbGroup) {
                        ...
                        if (d !== u) {
                            if (null != d && d.overrideDrop(b, u))return;
            ...
            this.overrideDrop = function (a, b) {
                ...
                G(a, function (a) {
                    if (null != a._jsPlumbGroup) {
                        if (a._jsPlumbGroup === u)return;
                        a._jsPlumbGroup.remove(a, !0, b, !1)
                    }
                    a._jsPlumbGroup = u, E.push(a), c.isAlreadyDraggable(a) && t(a), a.parentNode !== d && d.appendChild(a), b || c.fire(m, {
                        group: u,
                        el: a
                    })
                ...
                for (var d = 0, e = E.length; d < e; d++)u.remove(E[0], a, b, !0);
    ...
    var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a) {
        ...
        var c, d, e = b.Connectors.AbstractConnector.apply(this, arguments), f = null == a.midpoint ? .5 : a.midpoint,
            g = a.alwaysRespectStubs === !0, h = null, i = null, j = null != a.cornerRadius ? a.cornerRadius : 0,
                ...
                for (var d, f = null, g = 0; g < b.length - 1; g++) {
                    if (f = f || n(b[g]), d = n(b[g + 1]), j > 0 && f[4] !== d[4]) {
                        ...
                        var i = f[6] === d[5] && 1 === d[5] || f[6] === d[5] && 0 === d[5] && f[5] !== d[6] || f[6] === d[5] && d[5] === -1,
                            k = d[1] > f[3] ? 1 : -1, l = d[0] > f[2] ? 1 : -1, o = k === l,
                            p = o && i || !o && !i ? d[0] : f[2], q = o && i || !o && !i ? f[3] : d[1];
        ...
        this._compute = function (a, b) {
            ...
            var j = function () {
                    ...
                    perpendicular: j, orthogonal: j, opposite: function (b) {
                        var c = a, d = "x" === b ? 0 : 1, e = {
                            x: function () {
                ...
                }, m = k[a.anchorOrientation](a.sourceAxis), n = "x" === a.sourceAxis ? 0 : 1,
                p = "x" === a.sourceAxis ? 1 : 0, q = m[n], r = m[p], s = m[n + 2], t = m[p + 2];
            l(c, m[0], m[1], a);
            var u = a.startStubX + (a.endStubX - a.startStubX) * f, v = a.startStubY + (a.endStubY - a.startStubY) * f,
                w = {x: [0, 1], y: [1, 0]}, x = {
                    perpendicular: function (b) {
                        var c = a, d = {
                            ...
                            o = c.to[l] === -1 && j[b][1] < j[b][0] || 1 === c.to[l] && j[b][1] > j[b][0], p = e[b][m][0],
                            q = e[b][m][1], r = d[b][m][n];
    ...
    b.Connectors.AbstractBezierConnector = function (a) {
        ...
        var c, d = a.showLoopback !== !1, e = (a.curviness || 10, a.margin || 5),
            f = (a.proximityLimit || 80, a.orientation && "clockwise" === a.orientation), g = a.loopbackRadius || 25,
            h = !1;
    ...
    var d = function (a) {
        ...
        this.getCurviness = function () {
            ...
            var h, i, j = this.getGeometry(), k = d[0] < e[0] ? f : 0, l = d[1] < e[1] ? g : 0, m = d[0] < e[0] ? 0 : f,
                n = d[1] < e[1] ? 0 : g;
            (this.hasBeenEdited() || this.isEditing()) && null != j && null != j.controlPoints && null != j.controlPoints[0] && null != j.controlPoints[1] ? (h = j.controlPoints[0], i = j.controlPoints[1]) : (h = this._findControlPoint([k, l], d, e, b.sourceEndpoint, b.targetEndpoint, a.so, a.to), i = this._findControlPoint([m, n], e, d, b.targetEndpoint, b.sourceEndpoint, a.to, a.so)), c.setGeometry({controlPoints: [h, i]}, !0), c.addSegment(this, "Bezier", {
                x1: k,
                y1: l,
                x2: m,
                y2: n,
    ...
    var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = function (a, b, c, d) {
        ...
        this._computeBezier = function (a, b, j, k, l, m) {
            ...
            var r, s, t, u, v = (n + p) / 2, w = (o + q) / 2, x = d(n, o, p, q),
                y = Math.sqrt(Math.pow(p - n, 2) + Math.pow(q - o, 2)), z = f.getGeometry();
            (this.hasBeenEdited() || this.isEditing()) && null != z ? (r = z.controlPoints[0][0], t = z.controlPoints[0][1], s = z.controlPoints[1][0], u = z.controlPoints[1][1]) : (c = e(v, w, x, b.sourcePos, b.targetPos, g, g, y, i), r = c[0], s = c[0], t = c[1], u = c[1], f.setGeometry({controlPoints: [c, c]}, !0)), f.addSegment(this, "Bezier", {
                x1: p,
                y1: q,
                x2: n,
                y2: o,
    ...
    var a = this, b = a.jsPlumb, c = a.jsPlumbUtil, d = {
        ...
        q = "strokeWidth", r = {svg: "http://www.w3.org/2000/svg"}, s = function (a, b) {
            ...
            if (b.setAttribute(j, c.fill ? c.fill : o), b.setAttribute(l, c.stroke ? c.stroke : o), c.gradient ? w(a, b, c, g, h) : (v(a), b.setAttribute(n, "")), c.strokeWidth && b.setAttribute(m, c.strokeWidth), c[f] && c[q] && !c[e]) {
                var i = c[f].indexOf(",") === -1 ? " " : ",", k = c[f].split(i), p = "";
    ...
    var B = function (a, c) {
        ...
        this.path = null, this.paint = function (a, b) {
            if (a.component.svg && b) {
                null == this.path && (this.path = t("path", {"pointer-events": "all"}), a.component.svg.appendChild(this.path), this.elementCreated && this.elementCreated(this.path, a.component), this.canvas = a.component.svg);
    ...
    h(b.init)
}.call("undefined" != typeof window ? window : this), true, function () {
    "use strict";
    var a = this, b = a.Farahey = {};
    "undefined" != typeof exports && (exports.Farahey = b);
    var c = function (a, b, c) {
        for (var d = 0, e = a.length, f = -1, g = 0; d < e;)if (f = parseInt((d + e) / 2), g = c(a[f], b), g < 0) d = f + 1; else {
            if (!(g > 0))return f;
            e = f
        }
        return d
        ...
        var c = a.center || [a.x + a.w / 2, a.y + a.h / 2], e = b.center || [b.x + b.w / 2, b.y + b.h / 2],
            f = d.gradient(c, e), g = d.quadrant(c, e),
        ...
        var b, c = a.getPosition, d = a.getSize, g = a.getId, h = a.setPosition, i = a.padding || [20, 20],
            j = a.constrain || function (a, b, c) {
                    return c
                }, k = [], l = {}, m = {}, p = o(a.elements || []), q = a.origin || [0, 0], r = a.executeNow,
            s = (this.getOrigin = function () {
                ...
                return !0
                    ...
                    return !1
                }, u = a.orderByDistanceFromOrigin, v = new f(q, d), w = a.updateOnStep, x = a.stepInterval || 350,
            y = a.debug, z = function () {
                ...
                for (var i = 0; i < a.length; i++) {
                    ...
                    l[n] = [j.left, j.top], A([[j.left, j.top], n, a[i]]), m[n] = k, b = Math.min(b, j.left), e = Math.min(e, j.top), f = Math.max(f, j.left + k[0]), h = Math.max(h, j.top + k[1])
                }
                return [b, f, e, h]
            }, C = function () {
                return v.setOrigin(q), k = [], l = {}, m = {}, B(p)
            }, D = function (a) {
                if (p.length > 1) {
                    a = a || {};
                    var b = a.filter || s, c = a.padding || i, d = a.iterations, e = a.exclude || t, f = a.excludeFocus,
                ...
                for (var b = 0; b < p.length; b++) {
                    var c = g(p[b]);
                    a[c] && h(p[b], {left: l[c][0], top: l[c][1]})
                }
            }, F = function (a) {
                null != a && (q = a, v.setOrigin(a))
            };
        return this.execute = function (a, b) {
            F(a), C(), D(b)
        }, this.executeAtCenter = function (a) {
            var b = C();
            F([(b[0] + b[1]) / 2, (b[2] + b[3]) / 2]), D(a)
            ...
            y && (b.style.left = c.pageX + "px", b.style.top = c.pageY + "px"), this.execute([g, h], d)
            ...
            if (b) Array.prototype.push.apply(p, a); else for (var c = 0; c < a.length; c++)this.addElement(a[c]);
            return this
        }, this.getElements = function () {
            return p
        }, this.removeElement = function (a) {
            for (var b = -1, c = 0; c < p.length; c++)if (p[c] == a) {
                b = c;
                break
            }
    ...
    E(D.prototype, {
        ...
        compile: function (a, b, c, d) {
            for (var e = "data=[data||{}];var frag=_rotors.cf(),_els=[],e,_le,__a,$value,$key,_eid = _rotors.nec();_els.push(frag);", f = "return frag;", g = [], h = 0; h < a.length; h++) {
                var i = "";
                a[h].precompile && (i += a[h].precompile(this)), i += a[h].compile(this, d), a[h].postcompile && (i += a[h].postcompile(this)),
                    g.push(i)
            }
            var j = g.join("");
    ...
    var F = function (a) {
        ...
        return h[1] = G(e), h
    }, I = a.Rotors = {newInstance: F, precompile: H, data: h, version: "0.3.17", peek: b};
    "undefined" != typeof exports && (exports.Rotors = I, exports.RotorsInstance = D)
}.call("undefined" != typeof window ? window : this), true, function () {
    var a = this;
    ...
    b.Connection.prototype.animateOverlay = function (a, f) {
        ...
        f = f || {};
        var j, k, l, m = c.uuid(), n = f.forwards !== !1, o = f.rate || 30, p = f.dwell || 250, q = f.speed || 100,
            r = i / q * 1e3, s = r / o, t = 1 / s * (n ? 1 : -1), u = f.isFinal !== !1, v = n ? 0 : 1, w = v,
            x = function () {
                return n ? w >= 1 : w <= 0
...
}.call("undefined" == typeof window ? this : window), true, function () {
    "use strict";
    var a = this, b = ["node", "port", "edge", "group"], c = ["Refreshed", "Added", "Removed", "Updated", "Moved"],
        d = ["edge"], e = ["Source", "Target"], f = function (a, b, c, d) {
    ...
    b.Selection = function (a) {
        ...
        var s = function (a, b) {
            if (!m[a.getFullId()]) {
                var c = q(a);
                return c === !1 ? [[], []] : (m[a.getFullId()] = a, b && b(a, !0), [[a], c])
            }
            return [[], []]
        }, t = function (a, b) {
            ...
            var i = function (a) {
                var j;
                if (c.isString(a)) j = e.getNode(a) || e.getEdge(a) || e.getGroup(a), null != j && (f = b(j, d), g.push.apply(g, f[0]), h.push.apply(h, f[1])); else if (a.eachNode && a.eachEdge) a.eachNode(function (a, b) {
                    i(b)
    ...
    var c = function (a, b) {
        ...
        var c = {}, d = 0, f = {}, h = 0, l = {}, m = 0, n = !(a.defaultDirected === !1), q = a.defaultCost || 1,
            r = a.idFunction || function (a) {
                    return a.id
                }, s = a.typeFunction || function (a) {
                    return a.type || "default"
                }, t = a.enableSubgraphs === !0, u = a.portSeparator || ".", v = {}, w = function (a) {
                delete v[a.id]
            }, x = function (a) {
                v[a.id] = a
            }, y = function () {
        ...
        this.clear = function () {
            ...
            var d = null == a.directed ? n === !0 : !(a.directed === !1), g = a.cost || q, j = e(a.data, b, this),
            ...
            if (b = z(b), null == b)return {success: !1};
            var c = a.target;
            ...
            var b = this.getVertexCount(), c = (b - 1) * (b - 2) / 2, d = 0, e = 0, f = function (a, b, c, d, e) {
                ...
                } else for (var i = 0; i < g.length; i++)if (d.indexOf(g[i][0].id) == -1) {
                    var h = d.slice();
        ...
        compute: function (a) {
            ...
            for (var E = new Array(b.vertices.length), F = 0, G = function (a, b, c, d) {
                ...
                var H = l(r, E, g, q, u), I = H.node ? q(H.node) : null;
    ...
    a.jsPlumbToolkitInstance = function (i) {
        ...
        var j = i.idFunction || h, k = i.typeProperty || f, l = i.edgeTypeProperty || f, m = i.portTypeProperty || f,
            n = i.typeFunction || function (a) {
                    ...
                    return a[m] || g
                }, s = i.portExtractor, t = i.portUpdater, u = this, v = !1, w = !1, x = i.model || {},
            y = function (a, c, e) {
                c = null != c && b.isObject(c) ? c : {}, c = b.clone(c), c.id = c.id || d.uuid(), c.type = c.type || (null == a ? null : a.type || a), e(c)
            }, z = i.nodeFactory || y, A = i.edgeFactory || y, B = i.portFactory || y, C = i.groupFactory || y,
            D = i.autoSave && i.saveUrl, E = i.saveUrl, F = i.saveHeaders, G = i.onAutoSaveSuccess || function () {
                }, H = i.onAutoSaveError || function () {
                }, I = i.doNotUpdateOriginalData === !0, J = i.onBeforeAutoSave || function () {
                }, K = i.onAfterAutoSave || function () {
                }, L = {
                portSeparator: i.portSeparator,
                defaultCost: i.defaultCost,
                defaultDirected: i.defaultDirected,
                enableSubgraphs: i.enableSubgraphs
            }, M = i.createMissingGroups === !0;
        b.EventGenerator.apply(this, arguments);
        var N = new e.Graph(L);
        D && new d.AutoSaver(this, E, F, G, H, J, K), new d.CatchAllEventHandler(this), this.getNodeFactory = function () {
            return z
        ...
        var O, P = function () {
            return null == O && (O = new a.jsPlumbToolkit.Model(x || {})), O
        }, Q = function (a, b) {
            if (null == x)return !0;
            var c = this.getType(a), d = this.getType(b), e = P(), f = a.getNode ? a.getNode() : a,
        ...
        this.beforeConnect = i.beforeConnect || Q, this.beforeMoveConnection = i.beforeMoveConnection || Q, this.beforeStartConnect = i.beforeStartConnect || function (a, b) {
                return {}
            ...
            var b;
            if (!v) {
                var d = N.getVertex(a.source), e = N.getVertex(a.target), f = a.cost, g = a.directed;
                if (!d) {
                    if (a.doNotCreateMissingNodes)return;
                    d = N.addVertex(a.source), u.fire("nodeAdded", {data: {}, node: d})
                }
                if (!e) {
                    if (a.doNotCreateMissingNodes)return;
                    e = N.addVertex(a.target), u.fire("nodeAdded", {data: {}, node: e})
                }
                ...
                if (h) {
                    ...
                    j !== !1 && (b = N.addEdge({
                        ...
                        directed: g,
                        data: i
                    }), u.fire("edgeAdded", {edge: b}))
                }
            }
            return b
        }, this.clear = function () {
            return this.fire("graphClearStart"), N.clear(), this.fire("graphCleared"), this
        }, this.getGraph = function () {
            return N
        }, this.getNodeCount = function () {
            return N.getVertexCount()
        }, this.getNodeAt = function (a) {
            return N.getVertexAt(a)
        }, this.getNodes = function () {
            return N.getVertices()
        }, this.eachNode = function (a) {
            for (var b, c = 0, d = N.getVertexCount(); c < d; c++)b = N.getVertexAt(c), a(c, b)
        }, this.eachGroup = function (a) {
            for (var b, c = 0, d = N.getGroupCount(); c < d; c++)b = N.getGroupAt(c), a(c, b)
        }, this.eachEdge = function (a) {
            for (var b = N.getEdges(), c = 0, d = b.length; c < d; c++)a(c, b[c])
        }, this.getEdgeCount = function () {
            return N.getEdgeCount()
        }, this.getGroupCount = function () {
            return N.getGroupCount()
        }, this.getGroupAt = function (a) {
            return N.getGroupAt(a)
        }, this.getClusters = function () {
            return N.getClusters()
            ...
            if (null != g) {
                ...
                if ("string" != typeof b && null != b.group) {
                    ...
                    null == k && M && (k = N.addGroup(b.group)), null != k && k.addVertex(g)
                }
                return X || I || a.jsPlumbToolkitIO.manage("addNode", V, W, g, j || N.getIdFunction(), u), e || u.fire("nodeAdded", {
                    data: b,
                    node: g,
                    eventInfo: c
                }), g
            ...
            b = 2 != arguments.length || null != arguments[1] && "object" != typeof arguments[1] ? {} : arguments[1], c = 3 == arguments.length ? arguments[2] : "function" == typeof arguments[1] ? arguments[1] : null, b.type = b.type || a, z(a, b, function (a) {
                var b = this.addNode(a);
                c && c(b)
            }.bind(this))
        }, this.addNodes = function (a) {
            for (var b = 0; b < a.length; b++)u.addNode.apply(u, [a[b]]);
            return u
        }, this.addGroup = function (b, c, e) {
            var f = j(b);
            null == f && "string" != typeof b && (b.id = d.uuid());
            var g = N.addGroup(b, j);
            return X || I || a.jsPlumbToolkitIO.manage("addGroup", V, W, g, j || N.getIdFunction(), u), e || u.fire("groupAdded", {
                data: b,
                group: g,
                eventInfo: c
            }), g
            ...
            var c = !1;
            return a = u.getNode(a), b = u.getGroup(b), a && b && (c = b.addVertex(a), c && (a.data.group = b.id, u.fire("group:addMember", {
                node: a,
                group: this.getGroup(b)
            }), u.fire("dataUpdated"))), c
        }, this.removeFromGroup = function (a, b) {
            a = u.getNode(a);
            var c;
            return a && a.group && (c = a.group, c.deleteVertex(a), delete a.data.group, b || u.fire("group:removeMember", {
                node: a,
                group: c
            }), u.fire("dataUpdated")), c
        }, this.removeGroup = function (b, c, d) {
            var e = N.deleteGroup(b, c);
            e && (X || I || a.jsPlumbToolkitIO.manage("removeGroup", V, W, e, j || N.getIdFunction(), u), d || u.fire("groupRemoved", {
                group: e,
                removeChildNodes: c
            }))
        }, this.getNode = function (a) {
            return N.getVertex(a)
        }, this.getEdge = function (a) {
            return N.getEdge(a)
        }, this.getGroup = function (a) {
            return N.getGroup(a)
        }, this.exists = function (a) {
            for (var b = 0; b < arguments.length; b++)if (null == N.getVertex(arguments[b]))return !1;
            return !0
        }, this.removeNode = function (b, c) {
            b = b.constructor === e.Vertex || b.constructor === e.Port ? b : N.getVertex(b);
            for (var d = b.getAllEdges() || [], f = 0; f < d.length; f++)u.removeEdge(d[f]);
            return N.deleteVertex(b.id), X || I || a.jsPlumbToolkitIO.manage("removeNode", V, W, b, j || N.getIdFunction(), u), c || u.fire("nodeRemoved", {
                node: b,
                nodeId: b.id,
                edges: d
            }), u
        }, this.addEdge = function (b, c, d) {
            var e = N.addEdge(b, o, this.beforeConnect);
            return X || I || a.jsPlumbToolkitIO.manage("addEdge", V, W, e, o || N.getIdFunction(), u), d || u.fire("edgeAdded", {
                edge: e,
                source: c,
                geometry: b.geometry,
            ...
            return b = N.getEdge(b), null != b && (N.deleteEdge(b), X || I || a.jsPlumbToolkitIO.manage("removeEdge", V, W, b, o || N.getIdFunction(), u), u.fire("edgeRemoved", {
                edge: b,
                source: c
            }, null)), u
            ...
            var d = N.setTarget.apply(N, arguments);
            return d.success === !1 || c || u.fire("edgeTarget", d), d
        }, this.setSource = function (a, b, c) {
            var d = N.setSource.apply(N, arguments);
            return d.success === !1 || c || u.fire("edgeSource", d), d
        }, this.addNewPort = function (b, c, d, e) {
            b = N.getVertex(b), B({node: b, type: c}, d, function (c) {
                var d = q(c), f = b.addPort(d);
                f.data = c, S(b), X || I || a.jsPlumbToolkitIO.manage("addPort", V, W, {
                    node: b,
                    port: f
                }, q || N.getIdFunction(), u), e || u.fire("portAdded", {node: b, data: c, port: f}, null)
            })
        }, this.addPort = function (b, c, d) {
            var e = b.addPort(c, q);
            return S(b), X || I || a.jsPlumbToolkitIO.manage("addPort", V, W, {
                node: b,
                port: e
            }, q || N.getIdFunction(), u), d || u.fire("portAdded", {node: b, data: c, port: e}, null), e
        }, this.removePort = function (a, b, c) {
            var d = !1;
            a = a.constructor === e.Vertex || a.constructor === e.Port ? a : N.getVertex(a);
            var f = a.getPort(b);
            if (f) {
                var g = f.getAllEdges();
                if (d = a.removePort(f), d && !c) {
                    S(a), u.fire("portRemoved", {node: a, port: f, edges: g}, null);
                    for (var h = 0; h < g.length; h++)u.removeEdge(g[h])
                }
            }
            return d
        }, this.remove = function (a) {
            if (null != a) {
                var b = u.getObjectInfo(a);
                u.setSuspendRendering(!0);
                try {
                    if (!b.obj || "Node" !== b.type && "Edge" !== b.type && "Group" !== b.type) {
                        for (; a.getNodeCount() > 0;)u.removeNode(a.getNodeAt(0));
                        for (; a.getEdgeCount() > 0;)u.removeEdge(a.getEdgeAt(0));
                        for (; a.getGroupCount() > 0;)u.removeGroup(a.getGroupAt(0))
                    } else u["remove" + b.type](b.obj)
                } finally {
                    u.setSuspendRendering(!1, !0)
                }
            }
        }, this.setSuspendRendering = function (a, b) {
            for (var c in da)da[c].setSuspendRendering(a, b)
        ...
        var R = function (a, d, e, f, g) {
            var h = N.getNode(a);
            if (h && h.objectType) {
                var i = c.extend({}, h.data);
                if (d) {
                    for (var j in d)b.replace(h.data, j, d[j]);
                    "Port" === h.objectType && S(h.getNode())
                }
                u.fire(e, f(h, i), null)
            }
        }.bind(this), S = function (a) {
            if (null != t) {
        ...
        this.updateNode = function (a, b) {
            ...
            if (e) {
                ...
                u.fire("edgeUpdated", {edge: e, updates: d || {}, originalData: f}, null)
            }
        }, this.update = function (a, c) {
        ...
        var T = this.findGraphObject = function (a) {
            return null == a ? null : "*" === a ? N : a.constructor === e.Vertex || a.constructor === e.Port ? a : b.isString(a) || b.isObject(a) ? N.getVertex(a) : null
        }, U = function (a, b, c) {
            a = a || {};
            var d = [], f = {}, g = function (a) {
                ...
                if (null != d)for (var j = d[b]({filter: a.filter}), k = 0; k < j.length; k++) {
                    var l = f && d === N || j[k].source === d || c && j[k].source.constructor === e.Port && j[k].source.getNode() === d,
                        m = h && d === N || j[k].target === d || c && j[k].target.constructor === e.Port && j[k].target.getNode() === d;
                    (f && l || h && m || i && (l || m)) && g(j[k])
                }
            };
            return h(T(a.source), !0, !1, !1), h(T(a.target), !1, !0, !1), h(T(a.element), !1, !1, !0), d
        };
        this.getEdges = function (a) {
            return U(a, "getEdges", !1)
        }, this.getAllEdges = function () {
        ...
        var V, W, X, Y = function (b, c, e) {
            ...
            var m = function (b) {
                V = b, W = f, X = !0, u.fire(c), a.jsPlumbToolkitIO.parse(f, b, u, k), ca(e), j && j(u, b), u.fire("graphChanged")
            };
            if (g) m(g); else if (h) {
                if (i) {
                    var n = h.indexOf("?") === -1 ? "?" : "&";
        ...
        this.load = function (a) {
            return Y(a, "dataLoadStart", "dataLoadEnd")
        }, this.append = function (a) {
            return Y(a, "dataAppendStart", "dataAppendEnd")
            ...
            return b = b || {}, a.jsPlumbToolkitIO.exportData(b.type || "json", u, b.parameters)
        };
        var Z = function (a) {
            return new d.Selection({
                toolkit: u, onClear: a || function () {
                }
            })
        }, $ = Z(function (a) {
            u.fire("selectionCleared", {selection: a})
        });
        i.maxSelectedNodes && $.setMaxNodes(i.maxSelectedNodes), i.maxSelectedEdges && $.setMaxEdges(i.maxSelectedEdges), i.selectionCapacityPolicy && $.setCapacityPolicy(i.selectionCapacityPolicy);
        var _ = function (a, b, c, d) {
            return b || c.clear(!0), c.append(a, function (a) {
                d && u.fire("select", {append: b, obj: a, selection: c})
            })
        };
        ...
        var aa = function (a, b, c, d) {
            for (var e = a.getAllEdges(), f = 0, g = e.length; f < g; f++)if (e[f].source === a || e[f].getNode && e[f].getNode() === a) {
                ...
                d[i] || (b.append(h), c && b.append(e[f]), d[i] = !0, aa(h, b, c, d))
            }
        };
        this.selectDescendants = function (a, b, c) {
            var d = u.getObjectInfo(a), e = Z();
            if (d.obj && "Node" === d.obj.objectType) {
                b && _(d.obj, !0, e);
                var f = {};
                f[d.obj.getFullId()] = !0, aa(d.obj, e, c, f)
            }
            return e
            ...
            if (b) {
                var c = _(b.obj, !0, $, !0);
                ba("deselect", c[1]), ba("select", c[0])
            }
        };
        var ba = function (a, b) {
            for (var c = 0; c < b.length; c++)u.fire(a, {obj: b[c], selection: $})
        };
        this.toggleSelection = function (a) {
            var b = this.getObjectInfo(a);
            if (b) {
                var c = [], d = $.toggle(b.obj, function (a, b) {
                    b || c.push(a)
                });
                ba("deselect", d[1]), ba("deselect", c), ba("select", d[0])
            }
        }, this.removeFromSelection = function (a) {
            var b = this.getObjectInfo(a);
            b && $.remove(b.obj, function (a) {
                u.fire("deselect", {obj: a, selection: $})
            })
        }, this.addPathToSelection = function (a) {
            this.addToSelection(this.getPath(a))
        }, this.selectAll = function () {
            throw new TypeError("not implemented")
        }, this.clearSelection = $.clear, this.getSelection = function () {
            return $
        ...
        var ca = function (a) {
            u.setSuspendGraph(!0), u.fire(a), u.setSuspendGraph(!1), X = !1
        }, da = {};
        if (this.render = function (e, f) {
                var g = c.extend({}, f || {});
                c.extend(g, e), g.toolkit = u, null != e.selection && (e.selection.constructor === d.Selection ? g.toolkit = e.selection : g.toolkit = new d.Selection({
                    generator: e.selection,
                    toolkit: u
                }));
                var h = g.type || a.jsPlumbToolkit.DefaultRendererType, i = new a.jsPlumbToolkit.Renderers[h](g),
                    j = g.id || b.uuid();
                return da[j] = i, i.id = j, i
                ...
                var e = {els: {}, obj: null, type: null, id: null, el: null}, f = function (a) {
                    ...
                    var b = {};
                    for (var c in da)b[c] = [da[c], da[c].getRenderedElement(a)];
                    return b
                };
                if (null != a) {
                    ...
                    if (null != h && h.jtk) e.el = h, e.obj = h.jtk.port || h.jtk.node; else if (null != a.tagName) {
                        var i = f(h);
            ...
            var ea = i.dataType || "json";
            u.load({data: i.data, type: ea})
        }
...
}.call("undefined" != typeof window ? window : this), true,
    function () {
        "use strict";
        var a = this;
    ...
    c.AbstractLayout = function (b) {
        function c() {
            ...
            for (c = 0; c < h; c++)for (e = o.getGroupAt(c), a = e.getVertices(), d = 0; d < a.length; d++) {
                var i = g(a[d]);
                J(a[d].id, i[0], i[1])
            }
        }
        ...
        }, i = b.adapter, j = b.parameters || {}, k = b.getElementForNode, l = a.Farahey.getInstance({
            getPosition: function (a) {
                var b = p[a.id];
                ...
                J(a.id, b.left, b.top)
            }, padding: j.padding, filter: function (a) {
        ...
        var n = b.jsPlumb || a.jsPlumb, o = b.jsPlumbToolkit, p = {}, q = [], r = 1 / 0, s = 1 / 0, t = -(1 / 0),
            u = -(1 / 0), v = {}, w = {}, x = {}, y = b.container, z = n.getSize(y), A = b.width || z[0],
            B = b.height || z[1], C = !1, D = function () {
                C = !1, r = 1 / 0, t = -(1 / 0), s = 1 / 0, u = -(1 / 0);
                for (var a = 0; a < d.decorators.length; a++)d.decorators[a].reset({remove: n.remove});
        ...
        this.getMagnetizedElements = function () {
            ...
            a.force && this.forceMagnetize && this.forceMagnetize(), l[b].apply(l, c), N(n.repaintEverything)
            ...
            v[a.node.id] = a.node, J(a.node.id, c.left, c.top), E(a.node.id, a.el), l.addElement(a.node)
            ...
            w[a.group.id] = a.group, J(a.group.id, c.left, c.top), E(a.group.id, a.el), l.addElement(a.group)
        ...
        var E = function (a, b) {
            ...
            if (null != c) {
                var e = p[a];
                return d.adapter.setPosition(c, e[0], e[1], b), Q[a] = [e[0], e[1]], e.concat(E(a))
            }
            return null
        }.bind(this), N = this.draw = function (a) {
            for (var b in p) {
                var c = M(b);
    ...
    var g = c.AbsoluteBackedLayout = function (a) {
        ...
        var b = c.AbstractLayout.apply(this, arguments), d = function (a) {
            ...
            for (var g = b.adapter[a](), h = 0; h < g; h++) {
                var i = b.adapter[c](h), j = i.getFullId(), k = b.getPosition(j, null, null, !0);
    ...
    function () {
        ...
        c.Circular = function (a) {
            ...
            a = a || {};
            var e = c.AbstractLayout.apply(this, arguments), f = !!a.parameters && a.parameters.centerRootNode === !0;
            this.defaultParameters = {padding: 30, locationFunction: a.locationFunction}, this.step = function (a, c) {
                var g = [], h = e.adapter.getNodes();
                ...
                for (i = 0; i < g.length; i++)if (j = g[i], e.setPosition(j.id, k + Math.sin(o) * m, l + Math.cos(o) * m, !0), o += n, i > 0) {
                    var q = g[i - 1], r = e.getSize(q.id), s = e.getPosition(q.id), t = {
                            x: s[0] - c.padding,
                            y: s[1] - c.padding,
                            w: r[0] + 2 * c.padding,
                            h: r[1] + 2 * c.padding
                        }, u = g[i], v = e.getSize(u.id), w = e.getPosition(u.id), x = {
                            x: w[0] - c.padding,
                            y: w[1] - c.padding,
                            w: v[0] + 2 * c.padding,
                            h: v[1] + 2 * c.padding
                        }, y = d.calculateSpacingAdjustment(t, x), z = [s[0] + r[0] / 2, s[1] + r[1] / 2],
    ...
    c.Hierarchical = function (a) {
        var b, e, f, g, h, i, j, k = c.AbstractHierarchicalLayout.apply(this, arguments), l = [],
            m = null != a.parameters && a.parameters.compress, n = [], o = [], p = k.toolkit.getNodeId,
            q = function (a) {
                var b = n[a];
                ...
                if (a.size > 0) {
                    var b = a.parent.loc + a.parent.size / 2 - (a.size - h[f]) / 2, c = o[a.depth], d = -(1 / 0), e = 0;
                ...
                if (!i[a.node.id]) {
                    ...
                    for (c = 0; c < d.length; c++) {
                        ...
                        if (m.getNode && (m = m.getNode()), m = k.toolkit.getNode(m), null != m && m !== a.node && !l[m.id]) {
                            var n = k.getSize(p(m)), o = r(m, n, b + 1, a, e);
        ...
        this.begin = function (a, c) {
            ...
            for (var c, e, g, i = d.isArray(b.rootNode) ? b.rootNode : [b.rootNode], j = 0; j < i.length; j++) {
                c = i[j];
                var o = k.getSize(c.id), q = r(c, o, 0, null, null);
                q.root = !0, x(q, 0, null);
    ...
    c.Spring = function (a) {
        ...
        var d, e = this.defaultParameters, f = {}, g = a.absoluteBacked !== !1, h = 0, i = 1 / 0, j = -(1 / 0),
            k = 1 / 0, l = -(1 / 0), m = 1, n = 1, o = 0, p = function (a) {
        ...
        this._nodeMoved = this._groupMoved = function (a, b, c) {
            ...
            if (0 != o)for (f = 0; f < d.length; f++) {
                var w = j(f);
                if (!w.group) {
                    var x = e.c * w.f[0], y = e.c * w.f[1], z = e.maxVertexMovement;
    ...
    var h = b.atts = {NODE: "data-jtk-node-id", PORT: "data-jtk-port-id", GROUP: "data-jtk-group-id"},
        i = b.els = {SOURCE: "JTK-SOURCE", PORT: "JTK-PORT", TARGET: "JTK-TARGET"}, j = c.Classes, k = c.Constants,
        l = c.Events;
    b.mouseEvents = ["click", "dblclick", "contextmenu", "mousedown", "mouseup", "mousemove", "mouseenter", "mouseleave", "mouseover"], b.createElement = function (a, b) {
        var c = {width: a.width, height: a.height, position: a.position || k.absolute}, d = {};
    ...
    var m = b.DOMElementAdapter = function (a) {
        ...
        function m(a, b, c) {
            if (null == a.value("jtk-processed")) {
                ...
                var d = Aa(a, b, c), e = J.addEndpoint(a.element, d);
                xa[b.id + "." + d.portId] = e;
                var f = a.port || b.addPort({id: d.portId});
                e.graph = {node: b, port: f}, t.onUpdate(a.element, function () {
                })
            }
        }
        ...
        function n(a, b, c) {
            if (null == a.value("jtk-processed")) {
                a.setValue("jtk-processed", !0);
                var d = Aa(a, b, c);
                null != d.portId && (T[b.id + "." + d.portId] = a.element, a.element.jtk = a.element.jtk || {}, a.element.jtk.port = v.addPort(b, {
                    id: d.portId,
                ...
                if ("true" === a.value("is-source") && (d.isSource = !0), delete d.uniqueEndpoint, delete d.createEndpoint, d.extract = {}, a.findDataValues(d.extract), "true" === a.value("endpoint")) {
                    ...
                    var i = J.addEndpoint(a.element, d);
                    i.graph = {node: b}, ya[b.id] = i, t.onUpdate(a.element, function () {
                    })
                } else {
                    var j, k = a.element._katavorioDrop ? a.element._katavorioDrop.length : 0;
                    J.makeSource(a.element, d);
                    var l = a.element._katavorioDrop ? a.element._katavorioDrop.length : 0;
                    l > k && (j = a.element._katavorioDrop[a.element._katavorioDrop.length - 1]), t.onUpdate(a.element, function (a, c) {
                        var d = f.getSelector(a, "jtk-source");
                        if (1 === d.length) {
                            var e = Aa(d[0], b);
                            e.scope && (J.setSourceScope(a, e.scope, e.edgeType), j && j.k.setDropScope(j, e.scope))
                        }
                    })
                }
            }
        ...
        function o(a, b, c) {
            if (null == a.value("jtk-processed")) {
                a.setValue("jtk-processed", !0);
                var d = Aa(a, b, c);
                if (null != d.portId && (T[b.id + "." + d.portId] = a.element, a.element.jtk = a.element.jtk || {}, a.element.jtk.port = v.addPort(b, {
                        id: d.portId,
                        type: d.portType || "default"
                    }, !0)), "true" === a.value("is-target") && (d.isTarget = !0), delete d.uniqueEndpoint, delete d.createEndpoint, "true" === a.value("endpoint")) {
                    d.maxConnections = -1, d.isTarget = !0;
                    var e = J.addEndpoint(a.element, d);
                    e.graph = {node: b}, za[b.id] = e, t.onUpdate(a.element, function () {
                    })
                } else {
        ...
        a = a || {};
        var p = function (a, b) {
                var c = f.createElement("div", {border: "1px solid #456", position: "absolute"}, j.NODE);
                return c.innerHTML = a.name || a.id, c
            }, q = '<div data-jtk-node-id="${id}" class="' + j.NODE + '"></div>', r = {
                rotors: {
                    render: function (a, b) {
            ...
            t = g.newInstance({defaultTemplate: q, templateResolver: a.templateResolver, templates: a.templates}),
            u = this, v = a.toolkit, w = new c.Layouts.EmptyLayout(u), x = f.getElement(a.container),
            y = !(a.elementsDraggable === !1), z = a.elementsDroppable === !0, A = !1,
            B = a.refreshAutomatically !== !1,
            C = a.templateRenderer ? e.isString(a.templateRenderer) ? r[a.templateRenderer] : {render: a.templateRenderer} : r[s],
            D = a.enhancedView !== !1, E = a.assignPosse || function () {
                    return null
                }, F = a.modelLeftAttribute || "left", G = a.modelTopAttribute || "top", H = a.storePositionsInModel !== !1,
            I = e.merge(a.jsPlumb || {}), J = a.jsPlumbInstance || f.getInstance(I, a.overrideFns), K = J.getId(x);
        J.bind("beforeDrop", function (a) {
            ...
            return e === !1 && a.endpoint.isTemporarySource && a.endpoint._deleteOnDetach && J.deleteEndpoint(a.endpoint), e
        ...
        }), e.EventGenerator.apply(this, arguments), a.activeFiltering && new c.UI.ActiveDragFilter(u, J, v), this.getJsPlumb = function () {
            return J
        ...
        var L = [l.canvasClick, l.canvasDblClick, l.nodeAdded, l.nodeDropped, l.nodeRemoved, l.nodeRendered, l.groupAdded, l.groupRemoved, l.groupMoveEnd, l.groupMemberAdded, l.groupMemberRemoved, l.groupCollapse, l.groupExpand, l.nodeMoveStart, l.nodeMoveEnd, l.portAdded, l.portRemoved, l.edgeAdded, l.edgeRemoved, l.edgeTypeChanged, l.nodeTypeChanged, l.portTypeChanged, l.dataLoadEnd, l.anchorChanged, l.objectRepainted, l.modeChanged, l.lassoEnd, l.pan, l.zoom, l.relayout, l.click, l.tap, l.stateRestored, l.startOverlayAnimation, l.endOverlayAnimation],
            M = u.bind, N = J.bind;
        if (this.setHoverSuspended = J.setHoverSuspended, this.isHoverSuspended = J.isHoverSuspended, this.setJsPlumbDefaults = function (a) {
                delete a.Container, J.restoreDefaults(), J.importDefaults(a)
            }, this.bind = function (a, b) {
                L.indexOf(a) == -1 ? N(a, b) : M(a, b)
            }, a.events)for (var O in a.events)this.bind(O, a.events[O]);
        if (a.interceptors)for (var P in a.interceptors)this.bind(P, a.interceptors[P]);
        var Q = !1;
        N(l.connection, function (a) {
            if (null == a.connection.edge) {
                a.sourceEndpoint.getParameter("nodeId") || a.sourceEndpoint.setParameter("nodeId", S[a.sourceEndpoint.elementId].id), a.targetEndpoint.getParameter("nodeId") || a.targetEndpoint.setParameter("nodeId", S[a.targetEndpoint.elementId].id);
                var b = a.sourceEndpoint.getParameter("portType"), c = oa.getPortDefinition(b),
                    ...
                    i = e + (f ? "." + f : ""), j = g + (h ? "." + h : ""), k = {
                        ...
                        k.edge = v.addEdge({
                            ...
                            data: b,
                            addedByMouse: !0
                        }, u), Z[k.edge.getId()] = a.connection, a.connection.edge = k.edge, ba(d, k.edge, a.connection), k.addedByMouse = !0, u.fire(l.edgeAdded, k)
                    });
                m === !1 && J.deleteConnection(a.connection)
            }
            ...
            u.getLayout().setPosition(a.group.id, a.pos[0], a.pos[1], !0), a.uigroup = a.group, u.fire(l.groupMoveEnd, f.extend(a, {group: v.getGroup(a.uigroup.id)}))
        }), N(l.groupMemberAdded, function (a) {
            if (!A && a.el.jtk.node) {
                var b = v.addToGroup(a.el.jtk.node, a.group.id);
                b && u.fire(l.groupMemberAdded, {node: a.el.jtk.node, group: b, uigroup: a.group}), ja()
            }
        }), N(l.groupMemberRemoved, function (a) {
            if (!A && a.el.jtk.node) {
                var b = v.removeFromGroup(a.el.jtk.node);
                b && (u.nodeRemovedFromGroup(a.el), u.fire(l.groupMemberRemoved, {
                    node: a.el.jtk.node,
                    ugroup: b,
                    igroup: a.group
                })), ja()
            ...
            b && u.fire(l.groupCollapse, {group: b, uigroup: a.group})
        }), N(l.groupExpand, function (a) {
            var b = v.getGroup(a.group.id);
            b && u.fire(l.groupExpand, {group: b, uigroup: a.group})
        });
        var R = {}, S = {}, T = {}, U = {}, V = [], W = {}, X = [], Y = function (a) {
            var b = X.indexOf(a);
            b !== -1 && X.splice(b, 1)
        };
        this.getNodeCount = function () {
        ...
        var Z = {}, $ = function (a) {
            ...
            d.bind(a, function (a, e) {
                b.apply(b, [{edge: c, e: e, connection: d, toolkit: v, renderer: u}])
            })
        }, ba = function (a, b, c) {
            if (!c.getParameter("edge")) {
                var d = oa.getEdgeDefinition(a);
                if (d && d.events)for (var e in d.events)aa(e, d.events[e], b, c)
            }
        }, ca = function (a) {
            u.fire(l.edgeRemoved, {
        ...
        this.setSuspendRendering = function (a, b) {
            A = a, J.setSuspendDrawing(a), b && this.refresh()
        }, this.batch = function (a) {
            this.setSuspendEvents(!0), v.batch(a), this.setSuspendEvents(!1)
        };
        var da = function (a, b) {
            if (A) fa.push([a, b]); else {
                var c = E(b);
                if (null != c) {
                    var d = e.isArray(c) ? c : [c];
                    d.unshift(a), J.addToPosse.apply(J, d)
                }
            }
        }, ea = function () {
        ...
        if (this.bindToolkitEvents !== !1) {
            var ga = function () {
                fa.length = 0, J.setSuspendDrawing(!0), this.setSuspendRendering(!0)
            }.bind(this);
            v.bind(l.dataLoadStart, ga), v.bind(l.dataAppendStart, ga), v.bind(l.dataLoadEnd, function () {
                this.setSuspendRendering(!1), ea(), J.getGroupManager().refreshAllGroups(), ma(), u.relayout(), J.setSuspendDrawing(!1, !0), w && u.fire(l.dataLoadEnd)
            }.bind(this)), v.bind(l.dataAppendEnd, function () {
                this.setSuspendRendering(!1), ea(), u.refresh(), J.setSuspendDrawing(!1, !0), w && u.fire(l.dataAppendEnd)
            }.bind(this));
            var ha = function (a, b, c) {
                var d = U[c.id];
                if (d) {
                    var e = d.querySelector("[jtk-group-content]") || d;
                    e.appendChild(a), J.addToGroup(c.id, a, !0), u.nodeAppendedToGroup(a, d, c)
                }
            }, ia = function (a, b) {
                var c = R[a.id];
                if (null == c) {
                    ...
                    var e = J.getId(c);
                    R[a.id] = c, S[e] = a, X.push(a), c.jtk = {node: a}, null == a.group ? u.append(c, e, b ? b.position : null) : ha(c, a, a.group), da(c, a), Da(c, a);
                    var f = {node: a, el: c, id: a.id};
                    u.getLayout().nodeAdded(f, b), u.fire(l.nodeAdded, f)
                }
                return c
            };
            v.bind(l.nodeAdded, function (a) {
                ...
                if (null != d) {
                    ...
                    for (b = 0; b < e.length; b++) {
                        ...
                        T[c.id + "." + f] = e[b], e[b].jtk = e[b].jtk || {node: c, port: c.getPort(f)}
                    }
                    u.refresh(!0)
                }
                ...
                var b = R[a.nodeId];
                u.fire(l.nodeRemoved, {node: a.nodeId, el: b});
                var c = J.getId(b);
                t.remove(b), J.remove(b), delete R[a.nodeId], delete ya[a.nodeId], delete za[a.nodeId], delete S[c], Y(a.node), delete b.jtk, u.refresh(!0)
            });
            var ja = function () {
                a.relayoutOnGroupUpdate && u.relayout()
            };
            v.bind("group:addMember", ja), v.bind("group:removeMember", ja);
            var ka = function (b, c) {
                var d = U[b.id];
                if (null == d) {
                    ...
                    var h = J.getId(d);
                    U[b.id] = d, V.push(b), W[h] = b, d.jtk = {group: b}, u.append(d, h, c ? c.position : null), da(d, b), Da(d, b);
                    var i = {node: b, el: d}, j = {el: d, id: b.id};
                    f.extend(j, {dragOptions: a.dragOptions || {}}), j.dragOptions[f.dragEvents[k.stop]] = e.wrap(j.dragOptions[f.dragEvents[k.stop]], function (a) {
                        a.el.jtk && a.el.jtk.group && (j.dragOptions.magnetize ? a.pos = u.getLayout().setMagnetizedPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0) : u.getLayout().setPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0), H !== !1 && (u.storePositionInModel({
                            id: a.el.jtk.group.id,
                            group: !0,
                            leftAttribute: F,
                            topAttribute: G
                        }), v.fire(l.groupUpdated, {group: a.el.jtk.group}, null)), u.fire(l.groupMoveEnd, {
                            el: a.el,
                    ...
                    }), J.addGroup(f.extend(j, g)), u.getLayout().groupAdded({
                        group: b,
                        el: d,
                        id: b.id
                    }, c), u.fire(l.groupAdded, i)
                }
                return d
            };
            v.bind(l.groupAdded, function (a) {
                var b = a.group, c = ka(b, a.eventInfo);
                null != c && u.refresh(!0)
            }), v.bind(l.groupRemoved, function (a) {
                var b = a.group;
                u.getLayout().groupRemoved(b.id);
                var c = U[b.id], d = J.getId(c);
                J.removeGroup(b.id, a.removeChildNodes, !0, !1), delete U[b.id], delete W[d], delete c.jtk, u.refresh(!0)
            ...
            var la = function (a, b) {
                for (var c, d, e = a.getNodes(), f = 0, g = 0, h = u.getLayout(), i = J.getGroup(a.id), j = i.getDragArea(), k = b.autoSizePadding || [10, 10], l = 0; l < e.length; l++)c = h.getPosition(e[l].id), isNaN(c[0]) || isNaN(c[1]) || (d = h.getSize(e[l].id), f = Math.max(f, c[0] + d[0] + k[0]), g = Math.max(g, c[1] + d[1] + k[1]));
                f = b.maxSize ? Math.min(b.maxSize[0], f) : f, g = b.maxSize ? Math.min(b.maxSize[1], g) : g, j.style.width = f + "px", j.style.height = g + "px", h.setSize(a.id, [f, g])
            }, ma = function () {
                for (var a in U) {
                    var b = v.getGroup(a);
                    if (b) {
            ...
            var na = function (b, c) {
                return function () {
                    var d = ra(b);
                    d.doNotFireConnectionEvent = !0, c && (d.geometry = c), v.isDebugEnabled() && console.log("Renderer", "adding edge with params", d);
                    var e = J.connect(d);
                    e.edge = b, Z[b.getId()] = e, ba(d.type, b, e), u.fire(l.edgeAdded, {
                        source: b.source,
                        target: b.target,
                        connection: e,
                        edge: b,
                        geometry: c
                    }), a.refreshLayoutOnEdgeConnect && u.refresh(!0)
                }
            };
            v.bind(l.edgeAdded, function (b) {
                if (!Q && b.source !== u) {
                    var c = b.edge, d = oa.getEdgeDefinition(v.getEdgeType(c.data || {}));
                ...
                if (!Q && a.source !== u) {
                    var b = a.edge, c = Z[b.getId()];
                    c && (v.isDebugEnabled() && console.log("Renderer", "removing edge", b), ca(b), delete Z[b.getId()], null != c._jsPlumb && J.deleteConnection(c, {fireEvent: !1}))
                }
            }), v.bind(l.edgeTypeChanged, function (a) {
                if (!Q && a.source !== u) {
                    var b = a.obj, c = Z[b.getId()];
                    if (c) {
                ...
                if (!Q) {
                    var b = a.edge, c = Z[b.getId()], d = R[b.target.getFullId()];
                    c ? J.silently(function () {
                        null != d ? (v.isDebugEnabled() && console.log("target change", c), J.setTarget(c, d)) : (delete Z[b.getId()], J.detach({
                            connection: c,
                            forceDetach: !0,
                            fireEvent: !1
                        }))
                ...
                if (!Q) {
                    var b = a.edge, c = Z[b.getId()], d = R[b.source.getFullId()];
                    c ? J.silently(function () {
                        null != d ? J.setSource(c, d) : (delete Z[b.getId()], J.detach({
                            connection: c,
                            forceDetach: !0,
                            fireEvent: !1
                        }))
                ...
                for (var a in U)"undefined" != typeof U[a]._rotors && t.remove(U[a]), J.silently(function () {
                    J.getGroupManager().removeGroup(a)
                }), delete U[a].jtk;
                for (var b in R)"undefined" != typeof R[b]._rotors && t.remove(R[b]), J.remove(R[b], !0), delete R[b].jtk;
                w && w.clear(), J.setSuspendEvents(!0), J.batch(J.deleteEveryEndpoint, !0), J.setSuspendEvents(!1), X.length = 0, V.length = 0, Z = {}, R = {}, U = {}, S = {}, W = {}, T = {}, xa = {}
            }), v.bind(l.portAdded, function (a) {
                var b = R[a.node.id] || U[a.node.id], c = oa.getPortDefinition(v.getPortType(a.data));
                if (c.isEndpoint) m(new Ca(a.data, b, a.port), a.node); else {
                    var d = ua(a.port, a.data, a.node);
                    T[a.node.id + v.getGraph().getPortSeparator() + a.port.id] = d, Da(J.getElement(d), a.node), u.fire(l.portAdded, {
                        node: a.node,
                        nodeEl: b,
                        port: a.port,
                        portEl: d
                ...
                J.recalculateOffsets(b), u.refresh(!0)
            }), v.bind(l.portRemoved, function (a) {
                var b = R[a.node.id] || U[a.node.id], c = a.node.id + "." + a.port.id, d = T[c];
                J.setSuspendEvents(!0), J.remove(d), J.setSuspendEvents(!1), delete T[c], u.fire(l.portRemoved, {
                    node: a.node,
                    port: a.port,
                    portEl: d,
                    nodeEl: b
                ...
                b && (t.update(b, a.port.data), u.repaint(R[a.node.id]))
            }), v.bind(l.nodeUpdated, function (a) {
                var b = R[a.node.getFullId()];
                if (b) {
                    t.update(b, a.node.data), Da(b, a.node);
                    var c = E(a.node);
                    if (null != c) {
                        var d = e.isArray(c) ? c : [c];
                        d.unshift(b), J.setPosse.apply(J, d)
                    } else J.removeFromAllPosses(b);
                    u.repaint(b)
                }
            })
        }
        ...
        var pa = [], qa = function (a) {
            return null == a ? v : "string" == typeof a ? v.select(a, !0) : a.jtk ? v.select(a.jtk.port || a.jtk.node, !0) : a
        };
        this.activateState = function (a, b) {
            var c = oa.getState(a);
            c && (b = qa(b), c.activate(b, u, v), pa.push(c))
        }, this.deactivateState = function (a, b) {
            var c = oa.getState(a);
            c && (b = qa(b), c.deactivate(b, u, v), e.removeWithFunction(pa, function (a) {
                return a == c
            }))
        }, this.resetState = function () {
            for (var a = 0; a < pa.length; a++)pa[a].deactivate(v, u, v);
            pa.length = 0
        };
        var ra = function (a) {
                ...
                var e = function (a, b, c, d, e) {
                    ...
                    if (a[b].getNode) {
                        var f = a[b].getNode(), g = a[b].getFullId(), h = xa[g] || T[g];
                        null != h ? c[b] = h : c[b] = T[g], null == c[b] && (c[b] = R[v.getNodeId(f.data)]);
                        var i = oa.getPortDefinition(a[b].getType());
                        e(c, "anchors", "anchor", i, d), e(c, "endpoints", "endpoint", i, d)
                    } else {
                        var j = v.getNodeId(a[b].data), h = 0 === d ? ya[j] : za[j];
                        c[b] = null == h ? R[j] || U[j] : h
                    }
                };
                ...
                return function (j, k, l) {
                    ...
                    o = J.getElement(o), o.setAttribute(i, n), f.addClass(o, h), o.jtk = o.jtk || {}, o.jtk[a] = j, o.jtk.node = l, g && y && Ga.makeDraggable && Ga.makeDraggable(o, q.dragOptions), z && Ga.makeDroppable && Ga.makeDroppable(o, q.dropOptions);
                    var w = function (a) {
                        J.on(o, a, function (b) {
                            q.events[a]({node: l, el: o, e: b, toolkit: v, renderer: u})
                        })
                    };
                    if (q && q.events)for (m in q.events)w(m);
                    return o
                }
        ...
        this.initialize = function () {
            var b, c, d, e, f;
            if (v.setSuspendGraph(!0), J.setSuspendDrawing(!0), a.jsPlumbInstance) {
                ...
                for (var h in c) {
                    var i = c[h].el;
                    R[i.jtk.node.id] = i, S[a.jsPlumbInstance.getId(i)] = i.jtk.node
                }
                Ga.doImport && Ga.doImport(R, Z)
            } else {
                for (b = 0, d = v.getGroupCount(); b < d; b++)e = v.getGroupAt(b), ka(e);
                for (b = 0, d = v.getNodeCount(); b < d; b++)c = v.getNodeAt(b), ia(c);
                for (b = 0, d = v.getNodeCount(); b < d; b++)if (c = v.getNodeAt(b), R[c.id]) {
                    var j = v.getAllEdgesFor(c);
                    for (f = 0; f < j.length; f++)if (j[f].source == c || j[f].source.getNode && j[f].source.getNode() == c) {
            ...
            ma(), this.relayout(), J.setSuspendDrawing(!1, !0), v.setSuspendGraph(!1)
        }, this.getContainer = function () {
            return x
            ...
            var b = Fa(a), c = null;
            return b && b.obj && "Port" === b.obj.objectType && J.selectEndpoints({element: b.el}).each(function (a) {
                a.graph && a.graph.port && a.graph.port === b.obj && (c = a)
            }), c
        };
        var wa = function (a) {
            var b = J.extend({
                container: x, getElementForNode: function (a) {
                    return R[a] || U[a]
                }
            }, a);
            if (b.jsPlumbToolkit = v, b.adapter = u, !c.Layouts[b.type])throw"no such layout [" + b.type + "]";
        ...
        this.adHocLayout = function (a) {
            ...
            A || (w ? w.relayout(a, function () {
                J.repaintEverything(), this.fire("relayout", this.getBoundsInfo())
            ...
            return J.getSize(Fa(a).el)
        }, this.getCoordinates = function (a) {
            var b = this.getLayout();
            if (b) {
                var c = Fa(a), d = b.getPosition(c.id), e = J.getSize(c.el);
                return {x: d[0], y: d[1], w: e[0], h: e[1]}
            }
        };
        var xa = {}, ya = {}, za = {}, Aa = function (a, b, c) {
            var g = a.value("port-id"), h = a.value("port-type") || "default",
                i = a.value("scope") || J.getDefaultScope(), j = v.getNodeType(b), k = oa.getNodeDefinition(j),
                l = oa.getPortDefinition(g, k), m = oa.getPortDefinition(h, k), n = e.merge(m, l),
            ...
            if (o.connectionType = r, o.portId = g, o.portType = h, o.scope = i, o.parameters = o.parameters || {}, o.parameters.portId = g, o.parameters.portType = h, o.parameters.edgeType = r, o.parameters.scope = i, o.parameters.nodeId = b.id, o.events = {}, n.events)for (w in n.events)o.events[w] = p(n.events[w]);
            if (n.interceptors)for (w in n.interceptors)o[w] = q(n.interceptors[w]);
            var y = a.value("anchor-x"), z = a.value("anchor-y"), A = a.value("orientation-x"),
                B = a.value("orientation-y"), C = a.value("offset-x"), D = a.value("offset-y");
            ...
            for (c = 0; c < g.length; c++)d = new Ba(g[c]), n(d, b);
            for (c = 0; c < h.length; c++)d = new Ba(h[c]), o(d, b);
            for (c = 0; c < e.length; c++)d = new Ba(e[c]), m(d, b)
        };
        this.setLayout(a.layout, !0), this.storePositionsInModel = function (a) {
            a = a || {};
            var b = a.leftAttribute || "left", c = a.topAttribute || "top", d = w.getPositions();
            for (var e in d) {
            ...
            var b = "string" == typeof a ? a : a.id, c = "string" == typeof a ? "left" : a.leftAttribute || "left",
                d = "string" == typeof a ? "top" : a.topAttribute || "top", e = w.getPosition(b),
                f = v[a.group ? "getGroup" : "getNode"](b);
            return f && (g.data(f.data, c, e[0]), g.data(f.data, d, e[1])), e
        };
        var Ea = function (a, b, c, d, e, f, g) {
            return a = a || Fa(b), a && (w.setPosition(a.id, c, d), e || (J.setAbsolutePosition(a.el, [c, d], f, g), J.revalidate(a.el))), a
        };
        this.setPosition = function (a, b, c, d) {
            return Ea(null, a, b, c, d)
        }, this.animateToPosition = function (a, b, c, d) {
            var e = Fa(a);
            if (e) {
                var f = w.getPosition(e.id);
                Ea(e, a, b, c, !1, [f[0], f[1]], d)
            }
            ...
            if (null != a) {
                var f = function (a) {
                    ...
                    if (f) {
                        var g = !b || d(f);
                        g && (f.setVisible(b), c || (e(f, f.endpoints[0], b), e(f, f.endpoints[1], b)))
                    }
                }, g = function (a, d) {
                    if (d && (d.style.display = b ? "block" : "none", d._jtkVisible = b, !c))for (var e = v.getAllEdgesFor(a), g = 0; g < e.length; g++)f(e[g])
                }, h = function (a) {
                    var c = a.getFullId(), d = xa[c];
                    d.setVisible(b)
                }, i = function (a) {
                    var b = Fa(a);
                    switch (b.type) {
                ...
                if (a.eachNode && a.eachEdge) a.eachNode(function (a, b) {
                    ...
                    i(b)
                }); else if (a.length && "string" != typeof a)for (var j = 0; j < a.length; j++)i(a[j]); else i(a)
            }
        };
        var Fa = function (a) {
            return a instanceof J.getDefaultConnectionType() && (a = a.edge), v.getObjectInfo(a, function (a) {
        ...
        this.addToPosse = function (a, b, c) {
            d.each(a, function (a) {
                var d = Fa(a);
                d.el && J.addToPosse(d.el, {id: b, active: c !== !1})
            })
        }, this.setPosse = function (a, b) {
            d.each(a, function (a) {
                var c = Fa(a);
    ...
    function () {
        ...
        var a = this, b = {
            ...
            e = "function" == typeof b[d] ? b[d] : b[d][c], f = function (a) {
                return e(a || event)
            }, g = function (a, b, c) {
                return function (d) {
    ...
    this.ZoomWidget = function (a) {
        function d(b, c) {
            ...
            var d = Math.abs(ma.maxx[0][0][0] + ma.maxx[0][1] - ma.minx[0][0][0]),
                e = Math.abs(ma.maxy[0][0][1] + ma.maxy[0][2] - ma.miny[0][0][1]), f = a.width(u), h = a.height(u),
                i = f / ((d + 2 * b) / c), j = h / ((e + 2 * b) / c), k = Math.min(i, j);
            return {w: d, h: e, x: ma.minx[0][0][0], y: ma.miny[0][0][1], vw: f, vh: h, padding: b, z: k, zoom: ca}
        }

        function g() {
            for (var a in na)return !1;
            return !0
        }

        function h(a) {
            for (var b in ma)if (ma.hasOwnProperty(b)) {
                for (var c = -1, d = 0; d < ma[b].length; d++)if (ma[b][d][3] === a) {
                    c = d;
                    break
                }
                c != -1 && ma[b].splice(c, 1)
        ...
        var i, j, k, l, m, n, o = this, p = function () {
                ...
                return !0
            }, a.events.pan || p), x = a.events.mousedown || p, y = a.events.mouseup || p, z = a.events.mousemove || p,
            A = a.events.transformOrigin || p, B = !(a.clamp === !1), C = a.clampZoom !== !1, D = a.panDistance || 50,
            E = a.enablePan !== !1, F = a.enableWheelZoom !== !1, G = a.enableAnimation !== !1,
            H = a.wheelFilter || function () {
                    return !0
                }, I = a.wheelZoomMetaKey === !0, J = a.wheelReverse === !0 ? -1 : 1,
            K = J * (a.wheelSensitivity || 10), L = a.enablePanButtons !== !1, M = a.padding || [0, 0],
            N = a.consumeRightClick !== !1, O = a.smartMinimumZoom, P = !1, Q = "mousedown", R = "mouseup",
            S = "mousemove", T = ["webkit", "Moz", "ms"], U = a.bind, V = a.unbind, W = !(a.enabled === !1),
            X = a.clampToBackground, Y = a.clampToBackgroundExtents, Z = a.filter || function (a) {
                    return !1
                }, $ = a.width, _ = a.height, aa = 0, ba = 0, ca = a.zoom || 1, da = [0, 0], ea = !1, fa = !1, ga = !1,
            ha = !1, ia = a.zoomRange || [.05, 3], ja = 150, ka = -1, la = -1,
            ma = {minx: [], maxx: [], miny: [], maxy: []}, na = {}, oa = {}, pa = {}, qa = !1, ra = function () {
                ...
                null == na[a] && (na[a] = [], ma.minx.push(na[a]), ma.miny.push(na[a]), ma.maxx.push(na[a]), ma.maxy.push(na[a])), na[a][0] = b, na[a][1] = c, na[a][2] = d, na[a][3] = a, P ? qa = !0 : ra()
            };
        this.setBoundsFor = sa, this.setSuspendRendering = function (a) {
            P = a, !a && qa && ra(), qa = !1
        };
        var ta = function (a, b) {
            return function (c) {
                Ua(s, a * D, b * D, null, !0, function (a) {
                    w(a[0], a[1], ca, ca, c), i && i.pan(), db.pan()
                })
            }
        }, ua = 150, va = 60, wa = 10, xa = null, ya = null, za = null, Aa = function (b, c, d) {
            return function () {
                za = d, a.addClass(za, "jtk-surface-pan-active"), a.bind(document, "mouseup", Ba), xa = window.setTimeout(function () {
                    a.bind(document, R, Da), ya = window.setInterval(Ca(b, c), va)
                }, ua)
            }
        }, Ba = function () {
            window.clearTimeout(xa), za && a.removeClass(za, "jtk-surface-pan-active"), za = null
        }, Ca = function (a, b) {
            return function (c) {
                var d = Ua(s, a * wa, b * wa, null);
                w(d[0], d[1], ca, ca, c), i && i.pan(), db.pan()
            }
        }, Da = function () {
            ...
            return g.className = "jtk-surface-pan jtk-surface-pan-" + b, u.appendChild(g), a.bind(g, "click", ta(d, e)), a.bind(g, "mousedown", Aa(d, e, g)), g
        };
        L && (Ea("top", {left: "0px", top: "0px"}, 0, -1, "&#8593;"), Ea("bottom", {
            left: "0px",
            bottom: "0px"
        }, 0, 1, "&#8595;"), Ea("left", {left: "0px", top: "0px"}, -1, 0, "&#8592;"), Ea("right", {
            right: "0px",
            top: "0px"
        }, 1, 0, "&#8594;"));
        var Fa = function (a, b, c) {
            ...
            var d = Va(), e = a.offset(u, !0), f = Ta(s), g = a.width(q), h = a.height(q),
            ...
            e = -(i * (1 - ca)), f = -(j * (1 - ca)), da = a, Ga(), i = da[0] / 100 * b, j = da[1] / 100 * c, g = -(i * (1 - ca)), h = -(j * (1 - ca));
            ...
            if (!(null == a || isNaN(a) || a < 0)) {
                ...
                if (a > ia[1] && (a = ia[1]), e) {
                    var k = a > ca ? .05 : -.05, l = ca, m = a < ca, n = window.setInterval(function () {
                        l = Pa(l + k), m && l <= a && window.clearInterval(n), !m && l >= a && window.clearInterval(n)
                    });
                    return ca
                }
                Fa("transform", "scale(" + a + ")");
                var o = ca;
                if (ca = a, f || v(aa, ba, ca, o, b, c), null != i && i.setZoom(a), db && db.pan(), C) {
                    var p = Ta(s), q = Sa(p[0], p[1]);
                    q[0] == p[0] && q[1] == p[1] || Ta(s, q[0], q[1], null, !e)
                }
                return ca
            }
        }, Qa = function (a, b, c, d) {
            b < -ja && (b = -ja), b > ja && (b = ja), Ra(k, b, -ja, ja, c, d)
        }, Ra = function (a, b, c, d, e, f) {
            var g = b / (b >= 0 ? d : c), h = b >= 0 ? 1 : 0, i = a + g * (ia[h] - a);
            Pa(i, e, f)
        }, Sa = function (b, c, e) {
            if (B || X || Y) {
                var f = Va(), g = b, h = c,
                    j = B ? d() : {x: 0, y: 0, w: 0, h: 0, vw: a.width(u), vh: a.height(u), padding: e, z: 1};
                if (e = (e || 20) * ca, (X || Y) && null != i) {
                    var k = i.getWidth(), l = i.getHeight(), m = Math.max(j.x + j.w, k), n = Math.max(j.y + j.h, l);
                    j.w = m - j.w, j.h = n - j.h;
                    var o = j.vw / j.w, p = j.vh / j.h;
                    j.z = Math.min(o, p), Y && (e = Math.max(j.vw, j.vh))
                }
                var q = [j.x + j.w, j.y + j.h];
                i && (q[0] = Math.max(q[0], i.getWidth()), q[1] = Math.max(q[1], i.getHeight()));
                var r = b + f[0] + q[0] * ca - e, s = c + f[1] + q[1] * ca - e, t = b + f[0] + j.x * ca + e,
                    v = c + f[1] + j.y * ca + e;
            ...
            var i = Sa(c, d);
            return G && !f && a.animate ? a.animate(b, {left: i[0], top: i[1]}, {
        ...
        var Ua = function (a, b, c, d, e, f) {
            ...
            var b = a.width(q), c = a.height(q), d = da[0] / 100 * b, e = da[1] / 100 * c;
            return [d * (1 - ca), e * (1 - ca)]
        }, Wa = {
            start: function (b, c) {
                if (!fa) {
                    var d = b.srcElement || b.target;
                    W && (d == s || d == u || d._jtkDecoration || i && i.owns(d) || Z(d, b) === !0) && (ha = !1, ka = -1, la = -1, 3 !== b.which || a.enableWheelZoom === !1 || null != b.mozInputSource && 1 !== b.mozInputSource ? c.length <= 1 && (ea = !0, j = Ma(b), n = Ta(s)) : (ga = !0, j = Ma(b), Ka(b), n = Ta(s), k = ca)), x(b, o)
                }
            }, move: function (a, b) {
                var c, d, e;
                if (ha = !1, !fa) {
                    if (ga) e = Ma(a), c = e[0] - j[0], d = e[1] - j[1], Qa(c, d, a); else if (ea && E && null != j) {
                        e = Ma(a), c = e[0] - j[0], d = e[1] - j[1];
                        var f = Ta(s, n[0] + c, n[1] + d, a, !0);
                        w(f[0], f[1], ca, ca, a), i && i.pan(), db && db.pan()
                    }
                    z(a, o)
                }
            }, end: function (a, b) {
                fa || (ga = !1, j = null, ea = !1, ha = !1, V(document, S, Ya), V(document, R, Za), U(document, S, $a), y(a, o))
        ...
        var _a = this.start = function (a) {
            W && null != a && (V(document, S, $a), U(document, S, Ya), U(document, R, Za), Wa.start(a, Oa(a)))
        };
        if (U(t, Q, _a), U(t, "contextmenu", function (a) {
                Xa("contextmenu", a)
            }), F) {
            var ab = function (a) {
                H(a) && (a.preventDefault && a.preventDefault(), a.stopPropagation && a.stopPropagation(), k = ca, ha || (Ka(a), ha = !0), Qa(0, a.normalizedWheelDelta * K, a, !0))
            };
        ...
        new PinchListener({
            ...
            onPinchStart: function (a, b) {
                fa = !0, j = a, l = m = b, k = ca, Ja(j[0], j[1]), n = Ta(s)
            },
            onPinchEnd: function () {
                fa = !1, j = null
            }
        }), Pa(ca, null, !1, !1, !0), Ga(), this.positionChanged = function (b, c, d) {
            d = d || a.id(b);
            var e = c || Ta(b), f = a.width(b), g = a.height(b);
            oa[d] = b, sa(d, e, f, g)
        }, this.add = function (a, b, c, d) {
            this.positionChanged(a, c, b), d && (U(a, Q, _a), a._jtkDecoration = !0)
            ...
            var c = "string" == typeof b ? b : a.id(b);
            delete pa[c], this.positionChanged(b, null, c)
        }, this.remove = function (b) {
            b = r(b);
            var c = a.id(b);
            delete na[c], delete oa[c], delete pa[c], h(c)
        }, this.reset = function () {
            ma.minx.length = 0, ma.miny.length = 0, ma.maxx.length = 0, ma.maxy.length = 0, na = {}, oa = {}, pa = {}, Ta(s, 0, 0, null, !0)
        }, this.getBoundsInfo = d, this.zoomToFit = function (a) {
            a = a || {};
            var b = d(a.padding, a.fill);
            a.doNotZoomIfVisible && b.z > ca || Pa(b.z), o.centerContent({
                bounds: b,
            ...
            for (var c = {
                ...
                var e = b.elements[d], f = a.offset(e), g = a.width(e), h = a.height(e);
                c.x = Math.min(c.x, f.left), c.y = Math.min(c.y, f.top), c.xMax = Math.max(c.xMax, f.left + g), c.yMax = Math.max(c.yMax, f.top + h)
            }
            var i = a.fill || .9;
            c.w = i * (c.xMax - c.x), c.h = i * (c.yMax - c.y), c.z = Math.min(c.vw / c.w, c.vh / c.h), b.doNotZoomIfVisible && c.z > ca || Pa(c.z), o.centerContent({
                bounds: c,
            ...
            if (a = a || {}, null != i) {
                var b = i.getWidth(), c = i.getHeight(), d = $(u), e = _(u), f = d / b, g = e / c, h = Math.min(f, g),
                    j = {w: b, h: c, x: 0, y: 0, vw: d, vh: e, padding: 0, z: h};
                Pa(j.z), o.centerContent({
                    bounds: j,
            ...
            if (null != i) {
                var b = a.split(" "), c = b[0] || "left", e = b[1] || "top", f = d(),
                    g = "left" === c ? 0 : f.vw - i.getWidth() * ca, h = "top" === e ? 0 : f.vh - i.getHeight() * ca,
                    j = Va();
                Ta(s, g - j[0], h - j[1]), i.pan(), db && db.pan()
            }
        }, this.positionElementAt = function (b, c, d, e, f, g) {
            e = e || 0, f = f || 0;
            var h = Va(), i = Ta(s), j = r(b), k = j.parentNode, l = a.offset(k), m = a.offset(t),
                n = m.left - l.left + (i[0] + h[0]) + c * ca + e, o = m.top - l.top + (i[1] + h[1]) + d * ca + f;
            ...
            if (a.enablePan === !1) {
                ...
                var d = b.w + (b.x < 0 ? b.x : 0) + M[0], e = b.h + (b.y < 0 ? b.y : 0) + M[1];
                s.style.width = d + "px", s.style.height = e + "px";
                var f = 0 == d ? 0 : (b.x - M[0]) / d * 100, g = 0 == e ? 0 : (b.y - M[1]) / e * 100;
                this.setTransformOrigin(f, g)
            }
        }, this.nudgeZoom = function (b, c) {
            var d = a.offset(u, !0), e = d.left + a.width(u) / 2, f = d.top + a.height(u) / 2;
            return Ja(e, f), Pa(ca + b, c)
        }, this.nudgeWheelZoom = function (a, b) {
            k = ca, Qa(0, a, b, !0)
        }, this.centerContent = function (a) {
            a = a || {};
            var b = a.bounds || d(), c = Va(), e = b.x * ca + b.w * ca / 2, f = b.y * ca + b.h * ca / 2,
                g = b.vw / 2 - e, h = b.vh / 2 - f, j = Ta(s);
            Ta(s, a.horizontal !== !1 ? g - c[0] : j[0], a.vertical !== !1 ? h - c[1] : j[1], null, a.doNotAnimate, function () {
                a.doNotFirePanEvent || w(a.horizontal !== !1 ? g - j[0] : 0, a.vertical !== !1 ? h - j[1] : 0, ca, ca), i && i.pan(), db && db.pan(), a.onComplete && a.onComplete()
            }, a.onStep)
            ...
            c = c || {};
            var e = b.extend({}, d()), f = Ta(a), g = $(a), h = _(a);
            e.x = f[0], e.y = f[1], e.w = g, e.h = h;
            var i = function () {
                La(f[0] + g / 2, f[1] + h / 2), c.onComplete && c.onComplete()
            };
            this.centerContent({
                bounds: e,
            ...
            b = b || .6;
            var c = {w: $(a), h: _(a)}, e = Ta(a), f = d(), g = f.vw < f.vh ? [f.vw, "w"] : [f.vh, "h"], h = b * g[0],
                i = h / c[g[1]];
            i < ia[0] && (i = ia[0]), i > ia[1] && (i = ia[1]);
            var j = ca, k = i - ca;
            La(e[0] + c.w / 2, e[1] + c.h / 2), this.centerOn(a, {
                onStep: function (a, b) {
                    Pa(j + a / b * k)
                }, onComplete: function () {
                    Pa(i)
            ...
            var a = b.extend({}, d()), c = Va(), e = Ta(s), f = [a.vw / 2, a.vh / 2];
            return [(f[0] - (e[0] + c[0])) / ca, (f[1] - (e[1] + c[1])) / ca]
        }, this.setViewportCenter = function (a) {
            var c = b.extend({}, d()), e = Va(), f = [c.vw / 2, c.vh / 2],
            ...
            return null != a && 2 == a.length && a[0] < a[1] && null != a[0] && null != a[1] && a[0] > 0 && a[1] > 0 && (ia = a, b || (ca < ia[0] || ca > ia[1]) && Pa(ca)), this
            ...
            Ua(s, a, b, null, c, function (a) {
                w(a[0], a[1], ca, ca), i && i.pan(), db && db.pan()
            })
            ...
            var e = Va(), f = Ta(s), g = u.scrollLeft, h = u.scrollTop, i = d ? {left: 0, top: 0} : a.offset(u);
            return {left: (b - (f[0] + e[0]) - i.left + g) / ca, top: (c - (f[1] + e[1]) - i.top + h) / ca}
            ...
            var e = r(b), f = e.parentNode, g = a.offset(f), h = a.offset(t), i = Va(), j = g.left - h.left + i[0] + c,
                k = g.top - h.top + i[1] + d;
            ...
            var c = Va(), d = Ta(s, a - c[0], b - c[1], null, !0);
            return i && i.pan(), db && db.pan(), d
        }, this.applyZoomToElement = function (a, b) {
            b = b || ca, Fa("transform", "scale(" + b + ")", a)
        ...
        this.fixElement = function (b, c, d) {
            if (null != b) {
                ...
                bb[e] = {
                    ...
                    top: c.top,
                    pos: d
                }, b.style.position = "absolute", b.style.left = d[0] + "px", b.style.top = d[1] + "px", s.appendChild(b), cb(e)
            }
            ...
            for (g in f)if (!pa[g]) {
                var q = na[g];
                if (q) {
                    var r = {x: o[0] + q[0][0] * ca, y: o[1] + q[0][1] * ca, w: q[1] * ca, h: q[2] * ca};
                    n(m, r) && (null == e || e(g, oa[g], r)) && l.push({id: g, el: oa[g], r: r})
                }
            }
            return l
    ...
    var c = function (a) {
        ...
        this.getTileSpecs = function (a) {
            var d = b > c ? 1 : b / c, f = c > b ? 1 : c / b, g = Math.pow(2, a + 1) * e[0] * d,
                h = Math.pow(2, a + 1) * e[1] * f, i = Math.ceil(g / e[0]), j = Math.ceil(h / e[1]);
            return [i, j, g / b, h / c]
    ...
    function () {
        ...
        c.Surface = function (a) {
            ...
            var n, o = d.getElement(a.container), p = c.createElement({
                ...
                }, o), q = !(a.elementsDraggable === !1), r = a.elementsDroppable === !0, s = a.dragOptions || {},
                t = a.dropOptions || {}, u = a.stateHandle, v = a.storePositionsInModel !== !1,
                w = a.modelLeftAttribute, x = a.modelTopAttribute, y = new ZoomWidget({
                    viewport: o,
                    canvas: p,
                    ...
                    on: function () {
                        ...
                        m.jsPlumb.off.apply(m.jsPlumb, arguments)
                    }, invert: a.lassoInvert, pageLocation: y.pageLocation, canvas: o, onStart: function () {
                        ...
                        var f = [], g = y.findIntersectingNodes(a, b, !c[0]);
            ...
            l.bind(i.relayout, function (a) {
                ...
                if (b) {
                    var c = l.getJsPlumb().getGroup(a.group.id), d = l.getSize(c.getDragArea()), e = l.getSize(b);
                    y.suspend(b), l.fire(i.groupMemberAdded, a), m.jsPlumb.addToGroup(a.group.id, b, !0);
                ...
                var b = m.nodeMap()[a.node.id];
                if (b) {
                    y.restore(b), l.fire(i.groupMemberRemoved, a), m.jsPlumb.removeFromGroup(a.group.id, b, !0);
            ...
            m.makeDraggable = function (a, b) {
                if (q) {
                    var c = d.getElement(a), f = m.jsPlumb.getId(c), j = m.jsPlumb.extend({}, s),
                        k = d.dragEvents[h.stop], n = d.dragEvents[h.start], p = function (a) {
                    ...
                    null != b && m.jsPlumb.extend(j, b), j[n] = e.wrap(j[n], function () {
                        ...
                        for (var b = function (b) {
                            ...
                            j.magnetize && !c.node.group ? c.pos = l.getLayout().setMagnetizedPosition(c.node.id, c.pos[0], c.pos[1], !0) : l.getLayout().setPosition(c.node.id, c.pos[0], c.pos[1], !0), y.positionChanged(b[0]), v !== !1 && (l.storePositionInModel({
                                id: c.node.id,
                                leftAttribute: w,
                                topAttribute: x
                            }), m.toolkit.fire(i.nodeUpdated, {node: c.node}, null)), l.fire(i.nodeMoveEnd, c)
            ...
            this.zoomToFit = y.zoomToFit, this.zoomToFitIfNecessary = y.zoomToFitIfNecessary, this.zoomToSelection = function (a) {
                a = a || {};
                var b = a.selection || m.toolkit.getSelection(), c = [];
                b.eachNode(function (a, b) {
                    c.push(m.getElement(b.id))
                }), c.length > 0 && y.zoomToElements({elements: c, fill: a.fill})
            ...
            }, this.setWheelFilter(a.wheelFilter), this.setPanFilter(a.panFilter), this.mapLocation = y.mapLocation, this.mapEventLocation = y.mapEventLocation, this.findNearbyNodes = y.findNearbyNodes, this.findIntersectingNodes = y.findIntersectingNodes, this.findIntersectingGroups = function (a, b, c, d) {
                return y.findIntersectingNodes(a, b, c, d, m.reverseGroupMap())
            }, this.isInViewport = y.isInViewport, this.getViewportCenter = y.getViewportCenter, this.positionElementAt = y.positionElementAt, this.positionElementAtEventLocation = y.positionElementAtEventLocation, this.positionElementAtPageLocation = y.positionElementAtPageLocation, this.setFilter = y.setFilter, this.floatElement = y.floatElement, this.fixElement = y.fixElement;
            ...
            var Q = function (a) {
                function b(a) {
                    m.jsPlumb.hasClass(a, g.SURFACE_DROPPABLE_NODE) || (m.jsPlumb.addClass(a, g.SURFACE_DROPPABLE_NODE), m.jsPlumb.initDraggable(a, q, h.surfaceNodeDragScope, m.jsPlumb))
                }
                ...
                var c, f = a.dataGenerator || function () {
                    ...
                    p = a.droppables ? a.droppables : a.source ? a.source.querySelectorAll(a.selector) : [],
                    ...
                    t = function (b, c, d) {
                        ...
                        if (a.drop && (e = a.drop.apply(this, arguments) !== !1), e) {
                            var g = l.getJsPlumb(), h = m.jsPlumb.getDragObject(arguments),
                                i = g.getOffset(d ? F : h, !0), o = y.mapLocation(i.left, i.top),
                                p = j ? j(h, b, d, o) : null, q = f ? f(p, h, b, o) : {},
                            ...
                            k(o.left, o.top, q), r ? m.toolkit.getGroupFactory()(p, q, function (c) {
                                ...
                                a.onDrop && a.onDrop(d, b, o)
                            }, b, d) : m.toolkit.getNodeFactory()(p, q, function (c) {
                                var d = m.toolkit.addNode(c, {position: o});
                                null != n && (m.toolkit.addToGroup(d, n.group), l.setPosition(m.nodeMap()[d.id], o.left, o.top), g.getDragManager().updateOffsets(n.el)), a.onDrop && a.onDrop(d, b, o)
                            }, b, d)
                        }
                    }, u = function () {
                        ...
                        try {
                            ...
                            console.log("WARN: could not compute target groups for new node drag", a)
                        }
                        a.drag && a.drag.apply(a.drag, arguments)
                    }, w = d.dragEvents[h.start], x = d.dragEvents[h.drag], z = d.dragEvents[h.stop],
                    A = d.dragEvents[h.drop], B = function () {
                    }, C = a.nativeFilter || [], D = a.allowNative, E = {};
                if (q[w] = e.wrap(q[w], u), q[x] = e.wrap(q[x], v), q[z] = e.wrap(q[z], a.stop || B), r.scope = s, r[A] = e.wrap(r[A], t), D) {
                ...
                for (m.jsPlumb.initDroppable(o, r, h.surfaceNodeDragScope), q.scope = s, q.ignoreZoom = !0, q.doNotRemoveHelper = !0, c = 0; c < p.length; c++) {
                    var H = m.jsPlumb.getElement(p[c]);
                    b(H)
                }
                return {
                    refresh: function () {
    ...
    c.Miniview = function (a) {
        function b(a) {
            if (o && z && !t) {
                s = o.getBoundsInfo();
                var b = o.getApparentCanvasLocation(), c = z.getApparentCanvasLocation(), d = z.getZoom(),
                    f = d / s.zoom;
        ...
        function k(a) {
            if (null != z) {
                ...
                var b = z.getApparentCanvasLocation(), c = z.getZoom(), d = c / s.zoom, f = (b[0] - a[0]) / d,
                    g = (b[1] - a[1]) / d, h = o.setApparentCanvasLocation(f, g);
        ...
        var n, o = a.surface, p = e.getElement(a.container), q = c.createElement({
            ...
            }, p), s = a.bounds, t = a.suspended === !0, u = a.collapsible !== !1, v = a.typeFunction, w = null, x = !1,
            y = a.wheelSensitivity || 10, z = new ZoomWidget({
                viewport: p,
                canvas: q,
                ...
                if (D = !1, A) {
                    var b = z.pageLocation(a), c = b[0] - B[0], d = b[1] - B[1], f = [C[0] + c, C[1] + d];
                    k(f);
        ...
        var K = function (a) {
            z.zoomToFit({onComplete: b, onStep: b, doNotFirePanEvent: a})
        };
        ...
        var L = function (a) {
            ...
            if (!a.node || E(a.node) !== !1) {
                var h = e.getSize(a.el), j = c.createElement({
                    position: g.absolute,
                    width: h[0] + g.px,
                    height: h[1] + g.px,
                    left: 0,
                ...
                if (v && j.setAttribute("jtk-miniview-type", v(a.node)), j.relatedElement = a.el, j.jtk = a.node, s = o.getBoundsInfo(), j.setAttribute(i.jtkNodeId, a.node.id), j.setAttribute(i.relatedNodeId, a.el.getAttribute(g.id)), q.appendChild(j), z.add(j), l.nodeMap()[(a.node || a.group).id] = j, a.group) M(a.group, j); else if (a.node.group) {
        ...
        var S = function (a) {
            ...
            var a = l.nodeMap();
            for (var c in a)S({node: c, dontUpdatePanner: !0});
            b()
        };
        o.bind(h.pan, b), o.bind(h.zoom, b), o.bind(h.nodeMoveEnd, L), o.bind(h.nodeRemoved, S), o.bind(h.nodeAdded, N), o.bind(h.nodeRendered, N), o.bind(h.groupMoveEnd, L), o.bind(h.groupAdded, function (a) {
            ...
            var b = l.nodeMap()[a.group.id], c = l.nodeMap()[a.node.id];
            b && c && b.appendChild(c)
        }), o.bind(h.groupMemberRemoved, function (a) {
            var b = l.nodeMap()[a.node.id];
            b && q.appendChild(b)
        }), o.bind(h.groupCollapse, function (a) {
            Q(a.group, !1), R({id: a.group.id})
        }), o.bind(h.groupExpand, function (a) {
            Q(a.group, !0), R({id: a.group.id})
        }), o.bind(h.relayout, b), o.bind(h.objectRepainted, R), o.bind(h.stateRestored, b), a.toolkit.bind(h.graphClearStart, T);
        var U = function () {
            K(!0)
        };
    ...
    function () {
        ...
        c.Lasso = function (a) {
            var b, c = a.canvas, e = !1, m = {}, n = [0, 0], o = a.onStart || l, p = a.onEnd || l, q = a.onSelect || l,
                r = !1, s = !1, t = a.invert === !0, u = function (a, c) {
                    if (t) {
                        var d = window.innerWidth, e = window.innerHeight, f = window.scrollX, g = window.scrollY,
                            h = e - a[1] + g, j = e - h + c[1], k = d - a[0] + f, l = d - k + c[0];
    ...
    var y = function (a) {
        ...
        for (var b = e.querySelectorAll("[jtk-att]"), c = 0; c < b.length; c++) {
            var d = b[c].tagName.toUpperCase(),
                ...
                g = b[c].getAttribute("jtk-att"), h = u.data(a, g);
        ...
        for (var a = e.querySelectorAll("[jtk-att]"), b = {}, c = 0; c < a.length; c++) {
            var d = a[c].tagName.toUpperCase(),
                f = "INPUT" === d ? (a[c].getAttribute("type") || "TEXT").toUpperCase() : d, g = H[f](a[c]),
